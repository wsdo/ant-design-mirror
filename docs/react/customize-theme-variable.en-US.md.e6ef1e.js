(window.webpackJsonp=window.webpackJsonp||[]).push([[203],{3074:function(n,e){n.exports={content:["article",["p","Except ",["a",{title:null,href:"/docs/react/customize-theme"},"less customize theme"],", We also provide CSS Variable version to enable dynamic theme. You can check on ",["a",{title:null,href:"/components/config-provider/#components-config-provider-demo-theme"},"ConfigProvider"]," demo."],["h2","Notice"],["p","This function need CSS Variable support which mean it can not support IE. Please make sure your browser requirement."],["h2","How to use"],["h3","Import antd.variable.min.css"],["p","Replace your import style file with CSS Variable version:"],["pre",{lang:"diff",highlighted:`<span class="token deleted">-- import 'antd/dist/antd.min.css';</span>
