...
}`]],["p","Then you need to create a new file ",["code","src/models/useProductList.ts"],"."],["pre",{lang:"tsx",highlighted:`import { useRequest } from <span class="token string">'umi'</span><span class="token comment" spellcheck="true">;</span>
...
);`]],["p","Click here ",["a",{title:null,href:"https://procomponents.ant.design/en-US/components/layout"},"Quick Start"],"."],["h2","ProTable"],["p","Many data in an admin page does not need to be shared across pages, and models are sometimes not needed."],["pre",{lang:"tsx",highlighted:`import ProTable from <span class="token string">'@ant-design/pro-table'</span><span class="token comment" spellcheck="true">;</span>
