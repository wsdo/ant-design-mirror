...
+ import format from 'dayjs';`]],["p","如果按照上述步骤无法正确运行的话，你可以参考",["a",{title:null,href:"https://github.com/xiaohuoni/antd4-generate-picker/tree/master/antd-ts"},"antd4-generate-picker/antd-ts"],"。"],["p","如果你需要 JavaScript 代码，你可以参考 ",["a",{title:null,href:"https://github.com/xiaohuoni/antd4-generate-picker/tree/master/antd-demo"},"antd4-generate-picker/antd-demo"],"。"],["p","如果你熟悉 ",["a",{title:null,href:"https://umijs.org/"},"umi"],"，你可以参考 ",["a",{title:null,href:"https://github.com/xiaohuoni/antd4-use-dayjs-replace-moment"},"antd4-use-dayjs-replace-moment"],"。"],["h3","antd-dayjs-webpack-plugin"],["p","我们还提供另一种实现方式。使用 ",["code","antd-dayjs-webpack-plugin"]," 插件，无需对现有代码做任何修改直接替换成 ",["code","Day.js"],"。请参考 ",["a",{title:null,href:"https://github.com/ant-design/antd-dayjs-webpack-plugin"},"antd-dayjs-webpack-plugin"],"。"],["pre",{lang:"js",highlighted:`<span class="token comment" spellcheck="true">// webpack-config.js</span>
...
export default DatePicker;`]]],meta:{order:7.1,title:"替换 Moment.js",filename:"docs/react/replace-moment.zh-CN.md"},toc:["ul",["li",["a",{className:"bisheng-toc-h2",href:"#使用-date-fns",title:"使用 date-fns"},"使用 date-fns"]]]}}}]);
