(window.webpackJsonp=window.webpackJsonp||[]).push([[187],{3234:function(C,U,j){C.exports={"basic-controlled":j(3984),basic:j(3985),"big-data":j(3986),"customized-icon":j(3987),directory:j(3988),draggable:j(3989),dynamic:j(3990),line:j(3991),search:j(3992),"switcher-icon":j(3993),"virtual-scroll":j(3994)}},3984:function(C,U,j){C.exports={content:{"zh-CN":[["p","受控操作示例"]],"en-US":[["p","Controlled mode lets parent nodes reflect the status of child nodes more intelligently."]]},meta:{order:1,title:{"zh-CN":"受控操作示例","en-US":"Controlled Tree"},filename:"components/tree/demo/basic-controlled.md",id:"components-tree-demo-basic-controlled"},toc:["ul",["li",["a",{className:"bisheng-toc-h2",href:"#zh-CN",title:"zh-CN"},"zh-CN"]],["li",["a",{className:"bisheng-toc-h2",href:"#en-US",title:"en-US"},"en-US"]]],highlightedCode:["pre",{lang:"tsx",highlighted:`import React<span class="token punctuation">,</span> { useState } from <span class="token string">'react'</span><span class="token comment" spellcheck="true">;</span>
