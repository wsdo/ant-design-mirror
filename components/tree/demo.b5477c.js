(window.webpackJsonp=window.webpackJsonp||[]).push([[187],{3246:function(E,U,k){E.exports={"basic-controlled":k(4008),basic:k(4009),"big-data":k(4010),"customized-icon":k(4011),directory:k(4012),draggable:k(4013),dynamic:k(4014),line:k(4015),search:k(4016),"switcher-icon":k(4017),"virtual-scroll":k(4018)}},4008:function(E,U,k){E.exports={content:{"zh-CN":[["p","受控操作示例"]],"en-US":[["p","Controlled mode lets parent nodes reflect the status of child nodes more intelligently."]]},meta:{order:1,title:{"zh-CN":"受控操作示例","en-US":"Controlled Tree"},filename:"components/tree/demo/basic-controlled.md",id:"components-tree-demo-basic-controlled"},toc:["ul",["li",["a",{className:"bisheng-toc-h2",href:"#zh-CN",title:"zh-CN"},"zh-CN"]],["li",["a",{className:"bisheng-toc-h2",href:"#en-US",title:"en-US"},"en-US"]]],highlightedCode:["pre",{lang:"tsx",highlighted:`import React<span class="token punctuation">,</span> { useState } from <span class="token string">'react'</span><span class="token comment" spellcheck="true">;</span>
...
`},preview:function qa(){var q=k(0),V=k(26);function t(b){return typeof Symbol==="function"&&typeof Symbol.iterator==="symbol"?t=function n(c){return typeof c}:t=function n(c){return c&&typeof Symbol==="function"&&c.constructor===Symbol&&c!==Symbol.prototype?"symbol":typeof c},t(b)}var j=A(k(0)),u=k(7);function v(){if(typeof WeakMap!=="function")return null;var b=new WeakMap();return v=function n(){return b},b}function A(b){if(b&&b.__esModule)return b;if(b===null||t(b)!=="object"&&typeof b!=="function")return{default:b};var n=v();if(n&&n.has(b))return n.get(b);var c={},i=Object.defineProperty&&Object.getOwnPropertyDescriptor;for(var l in b)if(Object.prototype.hasOwnProperty.call(b,l)){var s=i?Object.getOwnPropertyDescriptor(b,l):null;s&&(s.get||s.set)?Object.defineProperty(c,l,s):c[l]=b[l]}return c.default=b,n&&n.set(b,c),c}function B(b,n){return Q(b)||H(b,n)||L(b,n)||F()}function F(){throw new TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function L(b,n){if(!b)return;if(typeof b==="string")return J(b,n);var c=Object.prototype.toString.call(b).slice(8,-1);c==="Object"&&b.constructor&&(c=b.constructor.name);if(c==="Map"||c==="Set")return Array.from(b);if(c==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(c))return J(b,n)}function J(b,n){(n==null||n>b.length)&&(n=b.length);for(var c=0,i=new Array(n);c<n;c++)i[c]=b[c];return i}function H(b,n){if(typeof Symbol==="undefined"||!(Symbol.iterator in Object(b)))return;var c=[],i=!0,l=!1,s=void 0;try{for(var x=b[Symbol.iterator](),I;!(i=(I=x.next()).done);i=!0){c.push(I.value);if(n&&c.length===n)break}}catch(K){l=!0,s=K}finally{try{!i&&x.return!=null&&x.return()}finally{if(l)throw s}}return c}function Q(b){if(Array.isArray(b))return b}var R=u.Tree.TreeNode,M=[{title:"0-0",key:"0-0",children:[{title:"0-0-0",key:"0-0-0",children:[{title:"0-0-0-0",key:"0-0-0-0"},{title:"0-0-0-1",key:"0-0-0-1"},{title:"0-0-0-2",key:"0-0-0-2"}]},{title:"0-0-1",key:"0-0-1",children:[{title:"0-0-1-0",key:"0-0-1-0"},{title:"0-0-1-1",key:"0-0-1-1"},{title:"0-0-1-2",key:"0-0-1-2"}]},{title:"0-0-2",key:"0-0-2"}]},{title:"0-1",key:"0-1",children:[{title:"0-1-0-0",key:"0-1-0-0"},{title:"0-1-0-1",key:"0-1-0-1"},{title:"0-1-0-2",key:"0-1-0-2"}]},{title:"0-2",key:"0-2"}],S=function b(){var n=(0,j.useState)(["0-0-0","0-0-1"]),c=B(n,2),i=c[0],l=c[1],s=(0,j.useState)(["0-0-0"]),x=B(s,2),I=x[0],K=x[1],r=(0,j.useState)([]),o=B(r,2),d=o[0],e=o[1],h=(0,j.useState)(!0),p=B(h,2),y=p[0],C=p[1],w=function f(g){console.log("onExpand",g),l(g),C(!1)},D=function f(g){console.log("onCheck",g),K(g)},a=function f(g,m){console.log("onSelect",m),e(g)};return j.default.createElement(u.Tree,{checkable:!0,onExpand:w,expandedKeys:i,autoExpandParent:y,onCheck:D,checkedKeys:I,onSelect:a,selectedKeys:d,treeData:M})};return j.default.createElement(S,null)}}},4009:function(E,U,k){E.exports={content:{"zh-CN":[["p","最简单的用法，展示可勾选，可选中，禁用，默认展开等功能。"]],"en-US":[["p","The most basic usage, tell you how to use checkable, selectable, disabled, defaultExpandKeys, and etc."]]},meta:{order:0,title:{"zh-CN":"基本","en-US":"Basic"},filename:"components/tree/demo/basic.md",id:"components-tree-demo-basic"},toc:["ul",["li",["a",{className:"bisheng-toc-h2",href:"#zh-CN",title:"zh-CN"},"zh-CN"]],["li",["a",{className:"bisheng-toc-h2",href:"#en-US",title:"en-US"},"en-US"]]],highlightedCode:["pre",{lang:"tsx",highlighted:`import { Tree } from <span class="token string">'antd'</span><span class="token comment" spellcheck="true">;</span>
...
ReactDOM<span class="token punctuation">.</span><span class="token function">render</span><span class="token punctuation">(</span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span><span class="token class-name">Demo</span></span> <span class="token punctuation">/></span></span><span class="token punctuation">,</span> mountNode<span class="token punctuation">)</span><span class="token punctuation">;</span>
`},preview:function qa(){var q=k(0),V=k(26),t=k(7),j=t.Tree.TreeNode,u=[{title:"parent 1",key:"0-0",children:[{title:"parent 1-0",key:"0-0-0",disabled:!0,children:[{title:"leaf",key:"0-0-0-0",disableCheckbox:!0},{title:"leaf",key:"0-0-0-1"}]},{title:"parent 1-1",key:"0-0-1",children:[{title:q.createElement("span",{style:{color:"#1890ff"}},"sss"),key:"0-0-1-0"}]}]}],v=function A(){var B=function L(J,H){console.log("selected",J,H)},F=function L(J,H){console.log("onCheck",J,H)};return q.createElement(t.Tree,{checkable:!0,defaultExpandedKeys:["0-0-0","0-0-1"],defaultSelectedKeys:["0-0-0","0-0-1"],defaultCheckedKeys:["0-0-0","0-0-1"],onSelect:B,onCheck:F,treeData:u})};return q.createElement(v,null)}}},4010:function(E,U,k){E.exports={content:{"zh-CN":[["p","大数据展示。"]],"en-US":[["p","Plenty of tree nodes."]]},meta:{order:99,title:{"zh-CN":"大数据","en-US":"Big data"},debug:!0,filename:"components/tree/demo/big-data.md",id:"components-tree-demo-big-data"},toc:["ul",["li",["a",{className:"bisheng-toc-h2",href:"#zh-CN",title:"zh-CN"},"zh-CN"]],["li",["a",{className:"bisheng-toc-h2",href:"#en-US",title:"en-US"},"en-US"]]],highlightedCode:["pre",{lang:"jsx",highlighted:`<span class="token keyword">import</span> <span class="token punctuation">{</span> Tree <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'antd'</span><span class="token punctuation">;</span>
...
ReactDOM<span class="token punctuation">.</span><span class="token function">render</span><span class="token punctuation">(</span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span><span class="token class-name">Demo</span></span> <span class="token punctuation">/></span></span><span class="token punctuation">,</span> mountNode<span class="token punctuation">)</span><span class="token punctuation">;</span>`},preview:function qa(){for(var q=k(0),V=k(26),t=k(7),j=[],u=0;u<100;u+=1){for(var v=[],A=0;A<100;A+=1)v.push({title:"child ".concat(u,"-").concat(A),key:"l-".concat(u,"-").concat(A)});j.push({title:"parent ".concat(u),key:"l-".concat(u),children:v})}var B=function F(){return q.createElement(t.Tree,{defaultExpandAll:!0,height:400,treeData:j})};return q.createElement(B,null)}}},4011:function(E,U,k){E.exports={content:{"zh-CN":[["p","可以针对不同的节点定制图标。"]],"en-US":[["p","You can customize icons for different nodes."]]},meta:{order:6,title:{"zh-CN":"自定义图标","en-US":"Customize Icon"},filename:"components/tree/demo/customized-icon.md",id:"components-tree-demo-customized-icon"},toc:["ul",["li",["a",{className:"bisheng-toc-h2",href:"#zh-CN",title:"zh-CN"},"zh-CN"]],["li",["a",{className:"bisheng-toc-h2",href:"#en-US",title:"en-US"},"en-US"]]],highlightedCode:["pre",{lang:"jsx",highlighted:`<span class="token keyword">import</span> <span class="token punctuation">{</span> Tree <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'antd'</span><span class="token punctuation">;</span>
...
ReactDOM<span class="token punctuation">.</span><span class="token function">render</span><span class="token punctuation">(</span>
  ...
  mountNode<span class="token punctuation">,</span>
<span class="token punctuation">)</span><span class="token punctuation">;</span>`},preview:function qa(){var q=k(0),V=k(26),t=k(7),j=k(44),u=[{title:"parent 1",key:"0-0",icon:q.createElement(j.SmileOutlined,null),children:[{title:"leaf",key:"0-0-0",icon:q.createElement(j.MehOutlined,null)},{title:"leaf",key:"0-0-1",icon:function v(A){var B=A.selected;return B?q.createElement(j.FrownFilled,null):q.createElement(j.FrownOutlined,null)}}]}];return q.createElement(t.Tree,{showIcon:!0,defaultExpandAll:!0,defaultSelectedKeys:["0-0-0"],switcherIcon:q.createElement(j.DownOutlined,null),treeData:u})}}},4012:function(E,U,k){E.exports={content:{"zh-CN":[["p","内置的目录树，",["code","multiple"]," 模式支持 ",["code","ctrl(Windows)"]," / ",["code","command(Mac)"]," 复选。"]],"en-US":[["p","Built-in directory tree. ",["code","multiple"]," support ",["code","ctrl(Windows)"]," / ",["code","command(Mac)"]," selection."]]},meta:{order:7,title:{"zh-CN":"目录","en-US":"directory"},filename:"components/tree/demo/directory.md",id:"components-tree-demo-directory"},toc:["ul",["li",["a",{className:"bisheng-toc-h2",href:"#zh-CN",title:"zh-CN"},"zh-CN"]],["li",["a",{className:"bisheng-toc-h2",href:"#en-US",title:"en-US"},"en-US"]]],highlightedCode:["pre",{lang:"tsx",highlighted:`import { Tree } from <span class="token string">'antd'</span><span class="token comment" spellcheck="true">;</span>
...
ReactDOM<span class="token punctuation">.</span><span class="token function">render</span><span class="token punctuation">(</span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span><span class="token class-name">Demo</span></span> <span class="token punctuation">/></span></span><span class="token punctuation">,</span> mountNode<span class="token punctuation">)</span><span class="token punctuation">;</span>`},preview:function qa(){var q=k(0),V=k(26),t=k(7);function j(d){return typeof Symbol==="function"&&typeof Symbol.iterator==="symbol"?j=function e(h){return typeof h}:j=function e(h){return h&&typeof Symbol==="function"&&h.constructor===Symbol&&h!==Symbol.prototype?"symbol":typeof h},j(d)}function u(d){return F(d)||B(d)||A(d)||v()}function v(){throw new TypeError(`Invalid attempt to spread non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function A(d,e){if(!d)return;if(typeof d==="string")return L(d,e);var h=Object.prototype.toString.call(d).slice(8,-1);h==="Object"&&d.constructor&&(h=d.constructor.name);if(h==="Map"||h==="Set")return Array.from(d);if(h==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(h))return L(d,e)}function B(d){if(typeof Symbol!=="undefined"&&Symbol.iterator in Object(d))return Array.from(d)}function F(d){if(Array.isArray(d))return L(d)}function L(d,e){(e==null||e>d.length)&&(e=d.length);for(var h=0,p=new Array(e);h<e;h++)p[h]=d[h];return p}function J(d,e){if(!(d instanceof e))throw new TypeError("Cannot call a class as a function")}function H(d,e){for(var h=0;h<e.length;h++){var p=e[h];p.enumerable=p.enumerable||!1,p.configurable=!0,"value"in p&&(p.writable=!0),Object.defineProperty(d,p.key,p)}}function Q(d,e,h){return e&&H(d.prototype,e),h&&H(d,h),d}function R(d,e){if(typeof e!=="function"&&e!==null)throw new TypeError("Super expression must either be null or a function");d.prototype=Object.create(e&&e.prototype,{constructor:{value:d,writable:!0,configurable:!0}}),e&&M(d,e)}function M(d,e){return M=Object.setPrototypeOf||function h(p,y){return p.__proto__=y,p},M(d,e)}function S(d){var e=c();return function h(){var p=i(d),y;if(e){var C=i(this).constructor;y=Reflect.construct(p,arguments,C)}else y=p.apply(this,arguments);return b(this,y)}}function b(d,e){return e&&(j(e)==="object"||typeof e==="function")?e:n(d)}function n(d){if(d===void 0)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return d}function c(){if(typeof Reflect==="undefined"||!Reflect.construct)return!1;if(Reflect.construct.sham)return!1;if(typeof Proxy==="function")return!0;try{return Date.prototype.toString.call(Reflect.construct(Date,[],function(){})),!0}catch(d){return!1}}function i(d){return i=Object.setPrototypeOf?Object.getPrototypeOf:function e(h){return h.__proto__||Object.getPrototypeOf(h)},i(d)}function l(d,e,h){return e in d?Object.defineProperty(d,e,{value:h,enumerable:!0,configurable:!0,writable:!0}):d[e]=h,d}var s=3,x=2,I=1,K=[],r=function d(e,h,p){for(var y=h||"0",C=p||K,w=[],D=0;D<s;D++){var a="".concat(y,"-").concat(D);C.push({title:a,key:a}),D<x&&w.push(a)}if(e<0)return C;var f=e-1;w.forEach(function(g,m){return C[m].children=[],d(f,g,C[m].children)})};r(I);var o=function(d){R(h,d);var e=S(h);function h(){var p;J(this,h);for(var y=arguments.length,C=new Array(y),w=0;w<y;w++)C[w]=arguments[w];return p=e.call.apply(e,[this].concat(C)),l(n(p),"state",{gData:K,expandedKeys:["0-0","0-0-0","0-0-0-0"]}),l(n(p),"onDragEnter",function(D){console.log(D)}),l(n(p),"onDrop",function(D){console.log(D);var a=D.node.props.eventKey,f=D.dragNode.props.eventKey,g=D.node.props.pos.split("-"),m=D.dropPosition-Number(g[g.length-1]),z=function O(T,Y,Z){for(var X=0;X<T.length;X++){if(T[X].key===Y)return Z(T[X],X,T);T[X].children&&O(T[X].children,Y,Z)}},G=u(p.state.gData),N;z(G,f,function(O,T,Y){Y.splice(T,1),N=O});if(!D.dropToGap)z(G,a,function(O){O.children=O.children||[],O.children.push(N)});else if((D.node.props.children||[]).length>0&&D.node.props.expanded&&m===1)z(G,a,function(O){O.children=O.children||[],O.children.unshift(N)});else{var P,W;z(G,a,function(O,T,Y){P=Y,W=T}),m===-1?P.splice(W,0,N):P.splice(W+1,0,N)}p.setState({gData:G})}),p}return Q(h,[{key:"render",value:function p(){return q.createElement(t.Tree,{className:"draggable-tree",defaultExpandedKeys:this.state.expandedKeys,draggable:!0,blockNode:!0,onDragEnter:this.onDragEnter,onDrop:this.onDrop,treeData:this.state.gData})}}]),h}(q.Component);return q.createElement(o,null)}}},4014:function(E,U,k){E.exports={content:{"zh-CN":[["p","点击展开节点，动态加载数据。"]],"en-US":[["p","To load data asynchronously when click to expand a treeNode."]]},meta:{order:3,title:{"zh-CN":"异步数据加载","en-US":"load data asynchronously"},filename:"components/tree/demo/dynamic.md",id:"components-tree-demo-dynamic"},toc:["ul",["li",["a",{className:"bisheng-toc-h2",href:"#zh-CN",title:"zh-CN"},"zh-CN"]],["li",["a",{className:"bisheng-toc-h2",href:"#en-US",title:"en-US"},"en-US"]]],highlightedCode:["pre",{lang:"tsx",highlighted:`import React<span class="token punctuation">,</span> { useState } from <span class="token string">'react'</span><span class="token comment" spellcheck="true">;</span>
import { Tree } from <span class="token string">'antd'</span><span class="token comment" spellcheck="true">;</span>
...
ReactDOM<span class="token punctuation">.</span><span class="token function">render</span><span class="token punctuation">(</span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span><span class="token class-name">Demo</span></span> <span class="token punctuation">/></span></span><span class="token punctuation">,</span> mountNode<span class="token punctuation">)</span><span class="token punctuation">;</span>
`},preview:function qa(){var q=k(0),V=k(26),t=v(k(0)),j=k(7);function u(){if(typeof WeakMap!=="function")return null;var a=new WeakMap();return u=function f(){return a},a}function v(a){if(a&&a.__esModule)return a;if(a===null||A(a)!=="object"&&typeof a!=="function")return{default:a};var f=u();if(f&&f.has(a))return f.get(a);var g={},m=Object.defineProperty&&Object.getOwnPropertyDescriptor;for(var z in a)if(Object.prototype.hasOwnProperty.call(a,z)){var G=m?Object.getOwnPropertyDescriptor(a,z):null;G&&(G.get||G.set)?Object.defineProperty(g,z,G):g[z]=a[z]}return g.default=a,f&&f.set(a,g),g}function A(a){return typeof Symbol==="function"&&typeof Symbol.iterator==="symbol"?A=function f(g){return typeof g}:A=function f(g){return g&&typeof Symbol==="function"&&g.constructor===Symbol&&g!==Symbol.prototype?"symbol":typeof g},A(a)}function B(a){return J(a)||L(a)||I(a)||F()}function F(){throw new TypeError(`Invalid attempt to spread non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function L(a){if(typeof Symbol!=="undefined"&&Symbol.iterator in Object(a))return Array.from(a)}function J(a){if(Array.isArray(a))return K(a)}function H(a,f){if(!(a instanceof f))throw new TypeError("Cannot call a class as a function")}function Q(a,f){for(var g=0;g<f.length;g++){var m=f[g];m.enumerable=m.enumerable||!1,m.configurable=!0,"value"in m&&(m.writable=!0),Object.defineProperty(a,m.key,m)}}function R(a,f,g){return f&&Q(a.prototype,f),g&&Q(a,g),a}function M(a,f){if(typeof f!=="function"&&f!==null)throw new TypeError("Super expression must either be null or a function");a.prototype=Object.create(f&&f.prototype,{constructor:{value:a,writable:!0,configurable:!0}}),f&&S(a,f)}function S(a,f){return S=Object.setPrototypeOf||function g(m,z){return m.__proto__=z,m},S(a,f)}function b(a){var f=i();return function g(){var m=l(a),z;if(f){var G=l(this).constructor;z=Reflect.construct(m,arguments,G)}else z=m.apply(this,arguments);return n(this,z)}}function n(a,f){return f&&(A(f)==="object"||typeof f==="function")?f:c(a)}function c(a){if(a===void 0)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return a}function i(){if(typeof Reflect==="undefined"||!Reflect.construct)return!1;if(Reflect.construct.sham)return!1;if(typeof Proxy==="function")return!0;try{return Date.prototype.toString.call(Reflect.construct(Date,[],function(){})),!0}catch(a){return!1}}function l(a){return l=Object.setPrototypeOf?Object.getPrototypeOf:function f(g){return g.__proto__||Object.getPrototypeOf(g)},l(a)}function s(a,f){return o(a)||r(a,f)||I(a,f)||x()}function x(){throw new TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function I(a,f){if(!a)return;if(typeof a==="string")return K(a,f);var g=Object.prototype.toString.call(a).slice(8,-1);g==="Object"&&a.constructor&&(g=a.constructor.name);if(g==="Map"||g==="Set")return Array.from(a);if(g==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(g))return K(a,f)}function K(a,f){(f==null||f>a.length)&&(f=a.length);for(var g=0,m=new Array(f);g<f;g++)m[g]=a[g];return m}function r(a,f){if(typeof Symbol==="undefined"||!(Symbol.iterator in Object(a)))return;var g=[],m=!0,z=!1,G=void 0;try{for(var N=a[Symbol.iterator](),P;!(m=(P=N.next()).done);m=!0){g.push(P.value);if(f&&g.length===f)break}}catch(W){z=!0,G=W}finally{try{!m&&N.return!=null&&N.return()}finally{if(z)throw G}}return g}function o(a){if(Array.isArray(a))return a}function d(a,f){var g=Object.keys(a);if(Object.getOwnPropertySymbols){var m=Object.getOwnPropertySymbols(a);f&&(m=m.filter(function(z){return Object.getOwnPropertyDescriptor(a,z).enumerable})),g.push.apply(g,m)}return g}function e(a){for(var f=1;f<arguments.length;f++){var g=arguments[f]!=null?arguments[f]:{};f%2?d(Object(g),!0).forEach(function(m){h(a,m,g[m])}):Object.getOwnPropertyDescriptors?Object.defineProperties(a,Object.getOwnPropertyDescriptors(g)):d(Object(g)).forEach(function(m){Object.defineProperty(a,m,Object.getOwnPropertyDescriptor(g,m))})}return a}function h(a,f,g){return f in a?Object.defineProperty(a,f,{value:g,enumerable:!0,configurable:!0,writable:!0}):a[f]=g,a}var p=j.Tree.TreeNode,y=[{title:"Expand to load",key:"0"},{title:"Expand to load",key:"1"},{title:"Tree Node",key:"2",isLeaf:!0}];function C(a,f,g){return a.map(function(m){return m.key===f?e(e({},m),{},{children:g}):m.children?e(e({},m),{},{children:C(m.children,f,g)}):m})}var w=function a(){var f=(0,t.useState)(y),g=s(f,2),m=g[0],z=g[1];function G(N){var P=N.key,W=N.children;return new Promise(function(O){if(W){O();return}setTimeout(function(){z(function(T){return C(T,P,[{title:"Child Node",key:"".concat(P,"-0")},{title:"Child Node",key:"".concat(P,"-1")}])}),O()},1e3)})}return t.default.createElement(j.Tree,{loadData:G,treeData:m})},D=function(a){M(g,a);var f=b(g);function g(){var m;H(this,g);for(var z=arguments.length,G=new Array(z),N=0;N<z;N++)G[N]=arguments[N];return m=f.call.apply(f,[this].concat(G)),h(c(m),"state",{treeData:[{title:"Expand to load",key:"0"},{title:"Expand to load",key:"1"},{title:"Tree Node",key:"2",isLeaf:!0}]}),h(c(m),"onLoadData",function(P){var W=m.state.treeData;return new Promise(function(O){var T=P.props;if(P.children){O();return}setTimeout(function(){P.children=[{title:"Child Node",key:"".concat(P.eventKey,"-0")},{title:"Child Node",key:"".concat(P.eventKey,"-1")}],m.setState({treeData:B(m.state.treeData)}),O()},1e3)})}),m}return R(g,[{key:"render",value:function m(){return t.default.createElement(j.Tree,{loadData:this.onLoadData,treeData:this.state.treeData})}}]),g}(t.default.Component);return t.default.createElement(w,null)}}},4015:function(E,U,k){E.exports={content:{"zh-CN":[["p","节点之间带连接线的树，常用于文件目录结构展示。使用 ",["code","showLine"]," 开启，可以用 ",["code","switcherIcon"]," 修改默认图标。"]],"en-US":[["p","Tree with connected line between nodes, turn on by ",["code","showLine"],", customize the preseted icon by ",["code","switcherIcon"],"."]]},meta:{order:5,title:{"zh-CN":"连接线","en-US":"Tree with line"},filename:"components/tree/demo/line.md",id:"components-tree-demo-line"},toc:["ul",["li",["a",{className:"bisheng-toc-h2",href:"#zh-CN",title:"zh-CN"},"zh-CN"]],["li",["a",{className:"bisheng-toc-h2",href:"#en-US",title:"en-US"},"en-US"]]],highlightedCode:["pre",{lang:"tsx",highlighted:`import React<span class="token punctuation">,</span> { useState } from <span class="token string">'react'</span><span class="token comment" spellcheck="true">;</span>
...
ReactDOM<span class="token punctuation">.</span><span class="token function">render</span><span class="token punctuation">(</span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span><span class="token class-name">Demo</span></span> <span class="token punctuation">/></span></span><span class="token punctuation">,</span> mountNode<span class="token punctuation">)</span><span class="token punctuation">;</span>
`},preview:function qa(){var q=k(0),V=k(26);function t(b){return typeof Symbol==="function"&&typeof Symbol.iterator==="symbol"?t=function n(c){return typeof c}:t=function n(c){return c&&typeof Symbol==="function"&&c.constructor===Symbol&&c!==Symbol.prototype?"symbol":typeof c},t(b)}var j=B(k(0)),u=k(7),v=k(44);function A(){if(typeof WeakMap!=="function")return null;var b=new WeakMap();return A=function n(){return b},b}function B(b){if(b&&b.__esModule)return b;if(b===null||t(b)!=="object"&&typeof b!=="function")return{default:b};var n=A();if(n&&n.has(b))return n.get(b);var c={},i=Object.defineProperty&&Object.getOwnPropertyDescriptor;for(var l in b)if(Object.prototype.hasOwnProperty.call(b,l)){var s=i?Object.getOwnPropertyDescriptor(b,l):null;s&&(s.get||s.set)?Object.defineProperty(c,l,s):c[l]=b[l]}return c.default=b,n&&n.set(b,c),c}function F(b,n){return R(b)||Q(b,n)||J(b,n)||L()}function L(){throw new TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function J(b,n){if(!b)return;if(typeof b==="string")return H(b,n);var c=Object.prototype.toString.call(b).slice(8,-1);c==="Object"&&b.constructor&&(c=b.constructor.name);if(c==="Map"||c==="Set")return Array.from(b);if(c==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(c))return H(b,n)}function H(b,n){(n==null||n>b.length)&&(n=b.length);for(var c=0,i=new Array(n);c<n;c++)i[c]=b[c];return i}function Q(b,n){if(typeof Symbol==="undefined"||!(Symbol.iterator in Object(b)))return;var c=[],i=!0,l=!1,s=void 0;try{for(var x=b[Symbol.iterator](),I;!(i=(I=x.next()).done);i=!0){c.push(I.value);if(n&&c.length===n)break}}catch(K){l=!0,s=K}finally{try{!i&&x.return!=null&&x.return()}finally{if(l)throw s}}return c}function R(b){if(Array.isArray(b))return b}var M=[{title:"parent 1",key:"0-0",icon:j.default.createElement(v.CarryOutOutlined,null),children:[{title:"parent 1-0",key:"0-0-0",icon:j.default.createElement(v.CarryOutOutlined,null),children:[{title:"leaf",key:"0-0-0-0",icon:j.default.createElement(v.CarryOutOutlined,null)},{title:"leaf",key:"0-0-0-1",icon:j.default.createElement(v.CarryOutOutlined,null)},{title:"leaf",key:"0-0-0-2",icon:j.default.createElement(v.CarryOutOutlined,null)}]},{title:"parent 1-1",key:"0-0-1",icon:j.default.createElement(v.CarryOutOutlined,null),children:[{title:"leaf",key:"0-0-1-0",icon:j.default.createElement(v.CarryOutOutlined,null)}]},{title:"parent 1-2",key:"0-0-2",icon:j.default.createElement(v.CarryOutOutlined,null),children:[{title:"leaf",key:"0-0-2-0",icon:j.default.createElement(v.CarryOutOutlined,null)},{title:"leaf",key:"0-0-2-1",icon:j.default.createElement(v.CarryOutOutlined,null),switcherIcon:j.default.createElement(v.FormOutlined,null)}]}]}],S=function b(){var n=(0,j.useState)(!0),c=F(n,2),i=c[0],l=c[1],s=(0,j.useState)(!1),x=F(s,2),I=x[0],K=x[1],r=(0,j.useState)(!0),o=F(r,2),d=o[0],e=o[1],h=function C(w,D){console.log("selected",w,D)},p=function C(w){e(w),l({showLeafIcon:w})},y=function C(w){w?d?l(w):l({showLeafIcon:d}):l(w)};return j.default.createElement("div",null,j.default.createElement("div",{style:{marginBottom:16}},"showLine: ",j.default.createElement(u.Switch,{checked:i,onChange:y}),j.default.createElement("br",null),j.default.createElement("br",null),"showIcon: ",j.default.createElement(u.Switch,{checked:I,onChange:K}),j.default.createElement("br",null),j.default.createElement("br",null),"showLeafIcon: ",j.default.createElement(u.Switch,{checked:d,onChange:p})),j.default.createElement(u.Tree,{showLine:i,showIcon:I,defaultExpandedKeys:["0-0-0"],onSelect:h,treeData:M}))};return j.default.createElement(S,null)}}},4016:function(E,U,k){E.exports={content:{"zh-CN":[["p","可搜索的树。"]],"en-US":[["p","Searchable Tree."]]},meta:{order:4,title:{"zh-CN":"可搜索","en-US":"Searchable"},filename:"components/tree/demo/search.md",id:"components-tree-demo-search"},toc:["ul",["li",["a",{className:"bisheng-toc-h2",href:"#zh-CN",title:"zh-CN"},"zh-CN"]],["li",["a",{className:"bisheng-toc-h2",href:"#en-US",title:"en-US"},"en-US"]]],highlightedCode:["pre",{lang:"jsx",highlighted:`<span class="token keyword">import</span> <span class="token punctuation">{</span> Tree<span class="token punctuation">,</span> Input <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'antd'</span><span class="token punctuation">;</span>
...
ReactDOM<span class="token punctuation">.</span><span class="token function">render</span><span class="token punctuation">(</span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span><span class="token class-name">SearchTree</span></span> <span class="token punctuation">/></span></span><span class="token punctuation">,</span> mountNode<span class="token punctuation">)</span><span class="token punctuation">;</span>`},preview:function qa(){var q=k(0),V=k(26),t=k(7);function j(r){return typeof Symbol==="function"&&typeof Symbol.iterator==="symbol"?j=function o(d){return typeof d}:j=function o(d){return d&&typeof Symbol==="function"&&d.constructor===Symbol&&d!==Symbol.prototype?"symbol":typeof d},j(r)}function u(r,o){if(!(r instanceof o))throw new TypeError("Cannot call a class as a function")}function v(r,o){for(var d=0;d<o.length;d++){var e=o[d];e.enumerable=e.enumerable||!1,e.configurable=!0,"value"in e&&(e.writable=!0),Object.defineProperty(r,e.key,e)}}function A(r,o,d){return o&&v(r.prototype,o),d&&v(r,d),r}function B(r,o){if(typeof o!=="function"&&o!==null)throw new TypeError("Super expression must either be null or a function");r.prototype=Object.create(o&&o.prototype,{constructor:{value:r,writable:!0,configurable:!0}}),o&&F(r,o)}function F(r,o){return F=Object.setPrototypeOf||function d(e,h){return e.__proto__=h,e},F(r,o)}function L(r){var o=Q();return function d(){var e=R(r),h;if(o){var p=R(this).constructor;h=Reflect.construct(e,arguments,p)}else h=e.apply(this,arguments);return J(this,h)}}function J(r,o){return o&&(j(o)==="object"||typeof o==="function")?o:H(r)}function H(r){if(r===void 0)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return r}function Q(){if(typeof Reflect==="undefined"||!Reflect.construct)return!1;if(Reflect.construct.sham)return!1;if(typeof Proxy==="function")return!0;try{return Date.prototype.toString.call(Reflect.construct(Date,[],function(){})),!0}catch(r){return!1}}function R(r){return R=Object.setPrototypeOf?Object.getPrototypeOf:function o(d){return d.__proto__||Object.getPrototypeOf(d)},R(r)}function M(r,o,d){return o in r?Object.defineProperty(r,o,{value:d,enumerable:!0,configurable:!0,writable:!0}):r[o]=d,r}var S=t.Input.Search,b=3,n=2,c=1,i=[],l=function r(o,d,e){for(var h=d||"0",p=e||i,y=[],C=0;C<b;C++){var w="".concat(h,"-").concat(C);p.push({title:w,key:w}),C<n&&y.push(w)}if(o<0)return p;var D=o-1;y.forEach(function(a,f){return p[f].children=[],r(D,a,p[f].children)})};l(c);var s=[],x=function r(o){for(var d=0;d<o.length;d++){var e=o[d],h=e.key;s.push({key:h,title:h}),e.children&&r(e.children)}};x(i);var I=function r(o,d){for(var e,h=0;h<d.length;h++){var p=d[h];p.children&&(p.children.some(function(y){return y.key===o})?e=p.key:r(o,p.children)&&(e=r(o,p.children)))}return e},K=function(r){B(d,r);var o=L(d);function d(){var e;u(this,d);for(var h=arguments.length,p=new Array(h),y=0;y<h;y++)p[y]=arguments[y];return e=o.call.apply(o,[this].concat(p)),M(H(e),"state",{expandedKeys:[],searchValue:"",autoExpandParent:!0}),M(H(e),"onExpand",function(C){e.setState({expandedKeys:C,autoExpandParent:!1})}),M(H(e),"onChange",function(C){var w=C.target.value,D=s.map(function(a){return a.title.indexOf(w)>-1?I(a.key,i):null}).filter(function(a,f,g){return a&&g.indexOf(a)===f});e.setState({expandedKeys:D,searchValue:w,autoExpandParent:!0})}),e}return A(d,[{key:"render",value:function e(){var h=this.state,p=h.searchValue,y=h.expandedKeys,C=h.autoExpandParent,w=function D(a){return a.map(function(f){var g=f.title.indexOf(p),m=f.title.substr(0,g),z=f.title.substr(g+p.length),G=g>-1?q.createElement("span",null,m,q.createElement("span",{className:"site-tree-search-value"},p),z):q.createElement("span",null,f.title);return f.children?{title:G,key:f.key,children:D(f.children)}:{title:G,key:f.key}})};return q.createElement("div",null,q.createElement(S,{style:{marginBottom:8},placeholder:"Search",onChange:this.onChange}),q.createElement(t.Tree,{onExpand:this.onExpand,expandedKeys:y,autoExpandParent:C,treeData:w(i)}))}}]),d}(q.Component);return q.createElement(K,null)},style:`.site-tree-search-value {
  color: #f50;
}
...
ReactDOM<span class="token punctuation">.</span><span class="token function">render</span><span class="token punctuation">(</span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span><span class="token class-name">Demo</span></span> <span class="token punctuation">/></span></span><span class="token punctuation">,</span> mountNode<span class="token punctuation">)</span><span class="token punctuation">;</span>`},preview:function qa(){var q=k(0),V=k(26),t=k(7),j=k(44);function u(c){return typeof Symbol==="function"&&typeof Symbol.iterator==="symbol"?u=function i(l){return typeof l}:u=function i(l){return l&&typeof Symbol==="function"&&l.constructor===Symbol&&l!==Symbol.prototype?"symbol":typeof l},u(c)}function v(c,i){if(!(c instanceof i))throw new TypeError("Cannot call a class as a function")}function A(c,i){for(var l=0;l<i.length;l++){var s=i[l];s.enumerable=s.enumerable||!1,s.configurable=!0,"value"in s&&(s.writable=!0),Object.defineProperty(c,s.key,s)}}function B(c,i,l){return i&&A(c.prototype,i),l&&A(c,l),c}function F(c,i){if(typeof i!=="function"&&i!==null)throw new TypeError("Super expression must either be null or a function");c.prototype=Object.create(i&&i.prototype,{constructor:{value:c,writable:!0,configurable:!0}}),i&&L(c,i)}function L(c,i){return L=Object.setPrototypeOf||function l(s,x){return s.__proto__=x,s},L(c,i)}function J(c){var i=R();return function l(){var s=M(c),x;if(i){var I=M(this).constructor;x=Reflect.construct(s,arguments,I)}else x=s.apply(this,arguments);return H(this,x)}}function H(c,i){return i&&(u(i)==="object"||typeof i==="function")?i:Q(c)}function Q(c){if(c===void 0)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return c}function R(){if(typeof Reflect==="undefined"||!Reflect.construct)return!1;if(Reflect.construct.sham)return!1;if(typeof Proxy==="function")return!0;try{return Date.prototype.toString.call(Reflect.construct(Date,[],function(){})),!0}catch(c){return!1}}function M(c){return M=Object.setPrototypeOf?Object.getPrototypeOf:function i(l){return l.__proto__||Object.getPrototypeOf(l)},M(c)}function S(c,i,l){return i in c?Object.defineProperty(c,i,{value:l,enumerable:!0,configurable:!0,writable:!0}):c[i]=l,c}var b=t.Tree.TreeNode,n=function(c){F(l,c);var i=J(l);function l(){var s;v(this,l);for(var x=arguments.length,I=new Array(x),K=0;K<x;K++)I[K]=arguments[K];return s=i.call.apply(i,[this].concat(I)),S(Q(s),"onSelect",function(r,o){console.log("selected",r,o)}),s}return B(l,[{key:"render",value:function s(){return q.createElement(t.Tree,{showLine:!0,switcherIcon:q.createElement(j.DownOutlined,null),defaultExpandedKeys:["0-0-0"],onSelect:this.onSelect},q.createElement(b,{title:"parent 1",key:"0-0"},q.createElement(b,{title:"parent 1-0",key:"0-0-0"},q.createElement(b,{title:"leaf",key:"0-0-0-0"}),q.createElement(b,{title:"leaf",key:"0-0-0-1"}),q.createElement(b,{title:"leaf",key:"0-0-0-2"})),q.createElement(b,{title:"parent 1-1",key:"0-0-1"},q.createElement(b,{title:"leaf",key:"0-0-1-0"})),q.createElement(b,{title:"parent 1-2",key:"0-0-2"},q.createElement(b,{title:"leaf",key:"0-0-2-0"}),q.createElement(b,{title:"leaf",key:"0-0-2-1"}))))}}]),l}(q.Component);return q.createElement(n,null)}}},4018:function(E,U,k){E.exports={content:{"zh-CN":[["p","使用 ",["code","height"]," 属性则切换为虚拟滚动。"]],"en-US":[["p","Use virtual list through ",["code","height"]," prop."]]},meta:{order:9,title:{"zh-CN":"虚拟滚动","en-US":"Virtual scroll"},filename:"components/tree/demo/virtual-scroll.md",id:"components-tree-demo-virtual-scroll"},toc:["ul",["li",["a",{className:"bisheng-toc-h2",href:"#zh-CN",title:"zh-CN"},"zh-CN"]],["li",["a",{className:"bisheng-toc-h2",href:"#en-US",title:"en-US"},"en-US"]]],highlightedCode:["pre",{lang:"jsx",highlighted:`<span class="token keyword">import</span> <span class="token punctuation">{</span> Tree <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'antd'</span><span class="token punctuation">;</span>
...
ReactDOM<span class="token punctuation">.</span><span class="token function">render</span><span class="token punctuation">(</span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span><span class="token class-name">Tree</span></span> <span class="token attr-name">treeData</span><span class="token script language-javascript"><span class="token script-punctuation punctuation">=</span><span class="token punctuation">{</span>treeData<span class="token punctuation">}</span></span> <span class="token attr-name">height</span><span class="token script language-javascript"><span class="token script-punctuation punctuation">=</span><span class="token punctuation">{</span><span class="token number">233</span><span class="token punctuation">}</span></span> <span class="token attr-name">defaultExpandAll</span> <span class="token punctuation">/></span></span><span class="token punctuation">,</span> mountNode<span class="token punctuation">)</span><span class="token punctuation">;</span>`},preview:function qa(){var q=k(0),V=k(26),t=k(7);function j(){for(var v=arguments.length>0&&arguments[0]!==void 0?arguments[0]:"0",A=arguments.length>1&&arguments[1]!==void 0?arguments[1]:3,B=[],F=0;F<10;F+=1){var L="".concat(v,"-").concat(F),J={title:L,key:L};A>0&&(J.children=j(L,A-1)),B.push(J)}return B}var u=j();return q.createElement(t.Tree,{treeData:u,height:233,defaultExpandAll:!0})}}}}]);
