(window.webpackJsonp=window.webpackJsonp||[]).push([[187],{3237:function(C,U,j){C.exports={"basic-controlled":j(3988),basic:j(3989),"big-data":j(3990),"customized-icon":j(3991),directory:j(3992),draggable:j(3993),dynamic:j(3994),line:j(3995),search:j(3996),"switcher-icon":j(3997),"virtual-scroll":j(3998)}},3988:function(C,U,j){C.exports={content:{"zh-CN":[["p","受控操作示例"]],"en-US":[["p","Controlled mode lets parent nodes reflect the status of child nodes more intelligently."]]},meta:{order:1,title:{"zh-CN":"受控操作示例","en-US":"Controlled Tree"},filename:"components/tree/demo/basic-controlled.md",id:"components-tree-demo-basic-controlled"},toc:["ul",["li",["a",{className:"bisheng-toc-h2",href:"#zh-CN",title:"zh-CN"},"zh-CN"]],["li",["a",{className:"bisheng-toc-h2",href:"#en-US",title:"en-US"},"en-US"]]],highlightedCode:["pre",{lang:"tsx",highlighted:`import React<span class="token punctuation">,</span> { useState } from <span class="token string">'react'</span><span class="token comment" spellcheck="true">;</span>
...
ReactDOM<span class="token punctuation">.</span><span class="token function">render</span><span class="token punctuation">(</span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span><span class="token class-name">Demo</span></span> <span class="token punctuation">/></span></span><span class="token punctuation">,</span> mountNode<span class="token punctuation">)</span><span class="token punctuation">;</span>
`},preview:function qa(){var p=j(0),V=j(26),t=j(7),k=t.Tree.TreeNode,u=[{title:"parent 1",key:"0-0",children:[{title:"parent 1-0",key:"0-0-0",disabled:!0,children:[{title:"leaf",key:"0-0-0-0",disableCheckbox:!0},{title:"leaf",key:"0-0-0-1"}]},{title:"parent 1-1",key:"0-0-1",children:[{title:p.createElement("span",{style:{color:"#1890ff"}},"sss"),key:"0-0-1-0"}]}]}],v=function y(){var A=function L(I,G){console.log("selected",I,G)},F=function L(I,G){console.log("onCheck",I,G)};return p.createElement(t.Tree,{checkable:!0,defaultExpandedKeys:["0-0-0","0-0-1"],defaultSelectedKeys:["0-0-0","0-0-1"],defaultCheckedKeys:["0-0-0","0-0-1"],onSelect:A,onCheck:F,treeData:u})};return p.createElement(v,null)}}},3990:function(C,U,j){C.exports={content:{"zh-CN":[["p","大数据展示。"]],"en-US":[["p","Plenty of tree nodes."]]},meta:{order:99,title:{"zh-CN":"大数据","en-US":"Big data"},debug:!0,filename:"components/tree/demo/big-data.md",id:"components-tree-demo-big-data"},toc:["ul",["li",["a",{className:"bisheng-toc-h2",href:"#zh-CN",title:"zh-CN"},"zh-CN"]],["li",["a",{className:"bisheng-toc-h2",href:"#en-US",title:"en-US"},"en-US"]]],highlightedCode:["pre",{lang:"jsx",highlighted:`<span class="token keyword">import</span> <span class="token punctuation">{</span> Tree <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'antd'</span><span class="token punctuation">;</span>
...
ReactDOM<span class="token punctuation">.</span><span class="token function">render</span><span class="token punctuation">(</span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span><span class="token class-name">Demo</span></span> <span class="token punctuation">/></span></span><span class="token punctuation">,</span> mountNode<span class="token punctuation">)</span><span class="token punctuation">;</span>`},preview:function qa(){for(var p=j(0),V=j(26),t=j(7),k=[],u=0;u<100;u+=1){for(var v=[],y=0;y<100;y+=1)v.push({title:"child ".concat(u,"-").concat(y),key:"l-".concat(u,"-").concat(y)});k.push({title:"parent ".concat(u),key:"l-".concat(u),children:v})}var A=function F(){return p.createElement(t.Tree,{defaultExpandAll:!0,height:400,treeData:k})};return p.createElement(A,null)}}},3991:function(C,U,j){C.exports={content:{"zh-CN":[["p","可以针对不同的节点定制图标。"]],"en-US":[["p","You can customize icons for different nodes."]]},meta:{order:6,title:{"zh-CN":"自定义图标","en-US":"Customize Icon"},filename:"components/tree/demo/customized-icon.md",id:"components-tree-demo-customized-icon"},toc:["ul",["li",["a",{className:"bisheng-toc-h2",href:"#zh-CN",title:"zh-CN"},"zh-CN"]],["li",["a",{className:"bisheng-toc-h2",href:"#en-US",title:"en-US"},"en-US"]]],highlightedCode:["pre",{lang:"jsx",highlighted:`<span class="token keyword">import</span> <span class="token punctuation">{</span> Tree <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'antd'</span><span class="token punctuation">;</span>
