...
`},preview:function(){var z=c(0),q=c(53);function D(d){return D=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(p){return typeof p}:function(p){return p&&typeof Symbol=="function"&&p.constructor===Symbol&&p!==Symbol.prototype?"symbol":typeof p},D(d)}var f=c(11),h=C(c(0));function i(d){if(typeof WeakMap!="function")return null;var p=new WeakMap,k=new WeakMap;return(i=function(s){return s?k:p})(d)}function C(d,p){if(!p&&d&&d.__esModule)return d;if(d===null||D(d)!=="object"&&typeof d!="function")return{default:d};var k=i(p);if(k&&k.has(d))return k.get(d);var m={},s=Object.defineProperty&&Object.getOwnPropertyDescriptor;for(var l in d)if(l!=="default"&&Object.prototype.hasOwnProperty.call(d,l)){var e=s?Object.getOwnPropertyDescriptor(d,l):null;e&&(e.get||e.set)?Object.defineProperty(m,l,e):m[l]=d[l]}return m.default=d,k&&k.set(d,m),m}function N(d,p){return R(d)||T(d,p)||S(d,p)||K()}function K(){throw new TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function S(d,p){if(!!d){if(typeof d=="string")return I(d,p);var k=Object.prototype.toString.call(d).slice(8,-1);if(k==="Object"&&d.constructor&&(k=d.constructor.name),k==="Map"||k==="Set")return Array.from(d);if(k==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(k))return I(d,p)}}function I(d,p){(p==null||p>d.length)&&(p=d.length);for(var k=0,m=new Array(p);k<p;k++)m[k]=d[k];return m}function T(d,p){var k=d==null?null:typeof Symbol!="undefined"&&d[Symbol.iterator]||d["@@iterator"];if(k!=null){var m=[],s=!0,l=!1,e,y;try{for(k=k.call(d);!(s=(e=k.next()).done)&&(m.push(e.value),!(p&&m.length===p));s=!0);}catch(n){l=!0,y=n}finally{try{!s&&k.return!=null&&k.return()}finally{if(l)throw y}}return m}}function R(d){if(Array.isArray(d))return d}var L=[{title:"0-0",key:"0-0",children:[{title:"0-0-0",key:"0-0-0",children:[{title:"0-0-0-0",key:"0-0-0-0"},{title:"0-0-0-1",key:"0-0-0-1"},{title:"0-0-0-2",key:"0-0-0-2"}]},{title:"0-0-1",key:"0-0-1",children:[{title:"0-0-1-0",key:"0-0-1-0"},{title:"0-0-1-1",key:"0-0-1-1"},{title:"0-0-1-2",key:"0-0-1-2"}]},{title:"0-0-2",key:"0-0-2"}]},{title:"0-1",key:"0-1",children:[{title:"0-1-0-0",key:"0-1-0-0"},{title:"0-1-0-1",key:"0-1-0-1"},{title:"0-1-0-2",key:"0-1-0-2"}]},{title:"0-2",key:"0-2"}],A=function(){var p=(0,h.useState)(["0-0-0","0-0-1"]),k=N(p,2),m=k[0],s=k[1],l=(0,h.useState)(["0-0-0"]),e=N(l,2),y=e[0],n=e[1],t=(0,h.useState)([]),o=N(t,2),r=o[0],b=o[1],w=(0,h.useState)(!0),x=N(w,2),a=x[0],u=x[1],v=function(U){console.log("onExpand",U),s(U),u(!1)},g=function(U){console.log("onCheck",U),n(U)},O=function(U,E){console.log("onSelect",E),b(U)};return h.default.createElement(f.Tree,{checkable:!0,onExpand:v,expandedKeys:m,autoExpandParent:a,onCheck:g,checkedKeys:y,onSelect:O,selectedKeys:r,treeData:L})},J=A;return z.createElement(J)}}},4835:function(P,Q,c){P.exports={content:{"zh-CN":[["p","\u6700\u7B80\u5355\u7684\u7528\u6CD5\uFF0C\u5C55\u793A\u53EF\u52FE\u9009\uFF0C\u53EF\u9009\u4E2D\uFF0C\u7981\u7528\uFF0C\u9ED8\u8BA4\u5C55\u5F00\u7B49\u529F\u80FD\u3002"]],"en-US":[["p","The most basic usage, tell you how to use checkable, selectable, disabled, defaultExpandKeys, and etc."]]},meta:{order:0,title:{"zh-CN":"\u57FA\u672C","en-US":"Basic"},filename:"components/tree/demo/basic.md",id:"components-tree-demo-basic"},toc:["ul",["li",["a",{className:"bisheng-toc-h2",href:"#zh-CN",title:"zh-CN"},"zh-CN"]],["li",["a",{className:"bisheng-toc-h2",href:"#en-US",title:"en-US"},"en-US"]]],highlightedCode:["pre",{lang:"tsx",highlighted:`import { Tree } from <span class="token string">'antd'</span><span class="token comment" spellcheck="true">;</span>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> App<span class="token punctuation">;</span>
`},preview:function(){var z=c(0),q=c(53),D=c(11),f=h(c(0));function h(T){return T&&T.__esModule?T:{default:T}}for(var i=[],C=0;C<100;C+=1){for(var N=[],K=0;K<100;K+=1)N.push({title:"child ".concat(C,"-").concat(K),key:"l-".concat(C,"-").concat(K)});i.push({title:"parent ".concat(C),key:"l-".concat(C),children:N})}var S=function(){return f.default.createElement(D.Tree,{defaultExpandAll:!0,height:400,treeData:i})},I=S;return z.createElement(I)}}},4837:function(P,Q,c){P.exports={content:{"zh-CN":[["p","\u53EF\u4EE5\u9488\u5BF9\u4E0D\u540C\u7684\u8282\u70B9\u5B9A\u5236\u56FE\u6807\u3002"]],"en-US":[["p","You can customize icons for different nodes."]]},meta:{order:6,title:{"zh-CN":"\u81EA\u5B9A\u4E49\u56FE\u6807","en-US":"Customize Icon"},filename:"components/tree/demo/customized-icon.md",id:"components-tree-demo-customized-icon"},toc:["ul",["li",["a",{className:"bisheng-toc-h2",href:"#zh-CN",title:"zh-CN"},"zh-CN"]],["li",["a",{className:"bisheng-toc-h2",href:"#en-US",title:"en-US"},"en-US"]]],highlightedCode:["pre",{lang:"tsx",highlighted:`import {
...
<span class="token keyword">export</span> <span class="token keyword">default</span> App<span class="token punctuation">;</span>
`},preview:function(){var z=c(0),q=c(53),D=c(56),f=c(11),h=i(c(0));function i(S){return S&&S.__esModule?S:{default:S}}var C=[{title:"parent 1",key:"0-0",icon:h.default.createElement(D.SmileOutlined,null),children:[{title:"leaf",key:"0-0-0",icon:h.default.createElement(D.MehOutlined,null)},{title:"leaf",key:"0-0-1",icon:function(I){var T=I.selected;return T?h.default.createElement(D.FrownFilled,null):h.default.createElement(D.FrownOutlined,null)}}]}],N=function(){return h.default.createElement(f.Tree,{showIcon:!0,defaultExpandAll:!0,defaultSelectedKeys:["0-0-0"],switcherIcon:h.default.createElement(D.DownOutlined,null),treeData:C})},K=N;return z.createElement(K)}}},4838:function(P,Q,c){P.exports={content:{"zh-CN":[["p","\u5185\u7F6E\u7684\u76EE\u5F55\u6811\uFF0C",["code","multiple"]," \u6A21\u5F0F\u652F\u6301 ",["code","ctrl(Windows)"]," / ",["code","command(Mac)"]," \u590D\u9009\u3002"]],"en-US":[["p","Built-in directory tree. ",["code","multiple"]," support ",["code","ctrl(Windows)"]," / ",["code","command(Mac)"]," selection."]]},meta:{order:7,title:{"zh-CN":"\u76EE\u5F55","en-US":"directory"},filename:"components/tree/demo/directory.md",id:"components-tree-demo-directory"},toc:["ul",["li",["a",{className:"bisheng-toc-h2",href:"#zh-CN",title:"zh-CN"},"zh-CN"]],["li",["a",{className:"bisheng-toc-h2",href:"#en-US",title:"en-US"},"en-US"]]],highlightedCode:["pre",{lang:"tsx",highlighted:`import { Tree } from <span class="token string">'antd'</span><span class="token comment" spellcheck="true">;</span>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> App<span class="token punctuation">;</span>`},preview:function(){var z=c(0),q=c(53);function D(a){return D=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(u){return typeof u}:function(u){return u&&typeof Symbol=="function"&&u.constructor===Symbol&&u!==Symbol.prototype?"symbol":typeof u},D(a)}var f=C(c(0)),h=c(11),i=c(56);function C(a){return a&&a.__esModule?a:{default:a}}function N(a){return T(a)||I(a)||S(a)||K()}function K(){throw new TypeError(`Invalid attempt to spread non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function S(a,u){if(!!a){if(typeof a=="string")return R(a,u);var v=Object.prototype.toString.call(a).slice(8,-1);if(v==="Object"&&a.constructor&&(v=a.constructor.name),v==="Map"||v==="Set")return Array.from(a);if(v==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(v))return R(a,u)}}function I(a){if(typeof Symbol!="undefined"&&a[Symbol.iterator]!=null||a["@@iterator"]!=null)return Array.from(a)}function T(a){if(Array.isArray(a))return R(a)}function R(a,u){(u==null||u>a.length)&&(u=a.length);for(var v=0,g=new Array(u);v<u;v++)g[v]=a[v];return g}function L(a,u){if(!(a instanceof u))throw new TypeError("Cannot call a class as a function")}function A(a,u){for(var v=0;v<u.length;v++){var g=u[v];g.enumerable=g.enumerable||!1,g.configurable=!0,"value"in g&&(g.writable=!0),Object.defineProperty(a,g.key,g)}}function J(a,u,v){return u&&A(a.prototype,u),v&&A(a,v),Object.defineProperty(a,"prototype",{writable:!1}),a}function d(a,u){if(typeof u!="function"&&u!==null)throw new TypeError("Super expression must either be null or a function");a.prototype=Object.create(u&&u.prototype,{constructor:{value:a,writable:!0,configurable:!0}}),Object.defineProperty(a,"prototype",{writable:!1}),u&&p(a,u)}function p(a,u){return p=Object.setPrototypeOf?Object.setPrototypeOf.bind():function(g,O){return g.__proto__=O,g},p(a,u)}function k(a){var u=l();return function(){var g=e(a),O;if(u){var M=e(this).constructor;O=Reflect.construct(g,arguments,M)}else O=g.apply(this,arguments);return m(this,O)}}function m(a,u){if(u&&(D(u)==="object"||typeof u=="function"))return u;if(u!==void 0)throw new TypeError("Derived constructors may only return object or undefined");return s(a)}function s(a){if(a===void 0)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return a}function l(){if(typeof Reflect=="undefined"||!Reflect.construct||Reflect.construct.sham)return!1;if(typeof Proxy=="function")return!0;try{return Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],function(){})),!0}catch(a){return!1}}function e(a){return e=Object.setPrototypeOf?Object.getPrototypeOf.bind():function(v){return v.__proto__||Object.getPrototypeOf(v)},e(a)}function y(a,u,v){return u in a?Object.defineProperty(a,u,{value:v,enumerable:!0,configurable:!0,writable:!0}):a[u]=v,a}var n=3,t=2,o=1,r=[],b=function a(u,v,g){for(var O=v||"0",M=g||r,U=[],E=0;E<n;E++){var Y="".concat(O,"-").concat(E);M.push({title:Y,key:Y,icon:f.default.createElement(i.CarryOutOutlined,null)}),E<t&&U.push(Y)}if(u<0)return M;var _=u-1;U.forEach(function($,V){return M[V].children=[],a(_,$,M[V].children)})};b(o);var w=function(a){d(v,a);var u=k(v);function v(){var g;L(this,v);for(var O=arguments.length,M=new Array(O),U=0;U<O;U++)M[U]=arguments[U];return g=u.call.apply(u,[this].concat(M)),y(s(g),"state",{gData:r,expandedKeys:["0-0","0-0-0","0-0-0-0"],showLine:!0,showIcon:!0,showLeafIcon:!0}),y(s(g),"onDragEnter",function(E){console.log(E)}),y(s(g),"onDrop",function(E){console.log(E);var Y=E.node.key,_=E.dragNode.key,$=E.node.pos.split("-"),V=E.dropPosition-Number($[$.length-1]),H=function B(G,sn,an){for(var nn=0;nn<G.length;nn++){if(G[nn].key===sn)return an(G[nn],nn,G);G[nn].children&&B(G[nn].children,sn,an)}},F=N(g.state.gData),j;if(H(F,_,function(B,G,sn){sn.splice(G,1),j=B}),!E.dropToGap)H(F,Y,function(B){B.children=B.children||[],B.children.push(j)});else if((E.node.props.children||[]).length>0&&E.node.props.expanded&&V===1)H(F,Y,function(B){B.children=B.children||[],B.children.unshift(j)});else{var W,X;H(F,Y,function(B,G,sn){W=sn,X=G}),V===-1?W.splice(X,0,j):W.splice(X+1,0,j)}g.setState({gData:F})}),y(s(g),"setShowLine",function(E){var Y=g.state.showLeafIcon;E?Y?g.setState({showLine:{showLeafIcon:!0}}):g.setState({showLine:!0}):g.setState({showLine:!1})}),y(s(g),"setShowIcon",function(E){g.setState({showIcon:E})}),y(s(g),"setShowLeafIcon",function(E){g.setState({showLeafIcon:E,showLine:{showLeafIcon:E}})}),g}return J(v,[{key:"render",value:function(){var O=this.state,M=O.showLine,U=O.showIcon,E=O.showLeafIcon,Y=O.expandedKeys,_=this.setShowLine,$=this.setShowIcon,V=this.setShowLeafIcon;return f.default.createElement(f.default.Fragment,null,f.default.createElement("div",{style:{marginBottom:16}},"showLine: ",f.default.createElement(h.Switch,{checked:M,onChange:_}),f.default.createElement("br",null),f.default.createElement("br",null),"showIcon: ",f.default.createElement(h.Switch,{checked:U,onChange:$}),f.default.createElement("br",null),f.default.createElement("br",null),"showLeafIcon: ",f.default.createElement(h.Switch,{checked:E,onChange:V})),f.default.createElement(h.Tree,{showLine:M,showIcon:U,className:"draggable-tree",defaultExpandedKeys:Y,draggable:!0,blockNode:!0,onDragEnter:this.onDragEnter,onDrop:this.onDrop,treeData:this.state.gData}))}}]),v}(f.default.Component),x=w;return z.createElement(x)}}},4840:function(P,Q,c){P.exports={content:{"zh-CN":[["p","\u5C06\u8282\u70B9\u62D6\u62FD\u5230\u5176\u4ED6\u8282\u70B9\u5185\u90E8\u6216\u524D\u540E\u3002"]],"en-US":[["p","Drag treeNode to insert after the other treeNode or insert into the other parent TreeNode."]]},meta:{order:2,title:{"zh-CN":"\u62D6\u52A8\u793A\u4F8B","en-US":"draggable"},filename:"components/tree/demo/draggable.md",id:"components-tree-demo-draggable"},toc:["ul",["li",["a",{className:"bisheng-toc-h2",href:"#zh-CN",title:"zh-CN"},"zh-CN"]],["li",["a",{className:"bisheng-toc-h2",href:"#en-US",title:"en-US"},"en-US"]]],highlightedCode:["pre",{lang:"tsx",highlighted:`import { Tree } from <span class="token string">'antd'</span><span class="token comment" spellcheck="true">;</span>
import type { DataNode<span class="token punctuation">,</span> TreeProps } from <span class="token string">'antd/lib/tree'</span><span class="token comment" spellcheck="true">;</span>
import React<span class="token punctuation">,</span> { useState } from <span class="token string">'react'</span><span class="token comment" spellcheck="true">;</span>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> App<span class="token punctuation">;</span>
`},preview:function(){var z=c(0),q=c(53);function D(n){return D=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(t){return typeof t}:function(t){return t&&typeof Symbol=="function"&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t},D(n)}var f=c(11),h=C(c(0));function i(n){if(typeof WeakMap!="function")return null;var t=new WeakMap,o=new WeakMap;return(i=function(b){return b?o:t})(n)}function C(n,t){if(!t&&n&&n.__esModule)return n;if(n===null||D(n)!=="object"&&typeof n!="function")return{default:n};var o=i(t);if(o&&o.has(n))return o.get(n);var r={},b=Object.defineProperty&&Object.getOwnPropertyDescriptor;for(var w in n)if(w!=="default"&&Object.prototype.hasOwnProperty.call(n,w)){var x=b?Object.getOwnPropertyDescriptor(n,w):null;x&&(x.get||x.set)?Object.defineProperty(r,w,x):r[w]=n[w]}return r.default=n,o&&o.set(n,r),r}function N(n,t){return R(n)||T(n,t)||S(n,t)||K()}function K(){throw new TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function S(n,t){if(!!n){if(typeof n=="string")return I(n,t);var o=Object.prototype.toString.call(n).slice(8,-1);if(o==="Object"&&n.constructor&&(o=n.constructor.name),o==="Map"||o==="Set")return Array.from(n);if(o==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(o))return I(n,t)}}function I(n,t){(t==null||t>n.length)&&(t=n.length);for(var o=0,r=new Array(t);o<t;o++)r[o]=n[o];return r}function T(n,t){var o=n==null?null:typeof Symbol!="undefined"&&n[Symbol.iterator]||n["@@iterator"];if(o!=null){var r=[],b=!0,w=!1,x,a;try{for(o=o.call(n);!(b=(x=o.next()).done)&&(r.push(x.value),!(t&&r.length===t));b=!0);}catch(u){w=!0,a=u}finally{try{!b&&o.return!=null&&o.return()}finally{if(w)throw a}}return r}}function R(n){if(Array.isArray(n))return n}var L=f.Input.Search,A=3,J=2,d=1,p=[],k=function n(t,o,r){for(var b=o||"0",w=r||p,x=[],a=0;a<A;a++){var u="".concat(b,"-").concat(a);w.push({title:u,key:u}),a<J&&x.push(u)}if(t<0)return w;var v=t-1;x.forEach(function(g,O){return w[O].children=[],n(v,g,w[O].children)})};k(d);var m=[],s=function n(t){for(var o=0;o<t.length;o++){var r=t[o],b=r.key;m.push({key:b,title:b}),r.children&&n(r.children)}};s(p);var l=function n(t,o){for(var r,b=0;b<o.length;b++){var w=o[b];w.children&&(w.children.some(function(x){return x.key===t})?r=w.key:n(t,w.children)&&(r=n(t,w.children)))}return r},e=function(){var t=(0,h.useState)([]),o=N(t,2),r=o[0],b=o[1],w=(0,h.useState)(""),x=N(w,2),a=x[0],u=x[1],v=(0,h.useState)(!0),g=N(v,2),O=g[0],M=g[1],U=function($){b($),M(!1)},E=function($){var V=$.target.value,H=m.map(function(F){return F.title.indexOf(V)>-1?l(F.key,p):null}).filter(function(F,j,W){return F&&W.indexOf(F)===j});b(H),u(V),M(!0)},Y=(0,h.useMemo)(function(){var _=function $(V){return V.map(function(H){var F=H.title,j=F.indexOf(a),W=F.substring(0,j),X=F.slice(j+a.length),B=j>-1?h.default.createElement("span",null,W,h.default.createElement("span",{className:"site-tree-search-value"},a),X):h.default.createElement("span",null,H.title);return H.children?{title:B,key:H.key,children:$(H.children)}:{title:B,key:H.key}})};return _(p)},[a]);return h.default.createElement("div",null,h.default.createElement(L,{style:{marginBottom:8},placeholder:"Search",onChange:E}),h.default.createElement(f.Tree,{onExpand:U,expandedKeys:r,autoExpandParent:O,treeData:Y}))},y=e;return z.createElement(y)},style:`.site-tree-search-value {
  color: #f50;
}
...
<span class="token keyword">export</span> <span class="token keyword">default</span> App<span class="token punctuation">;</span>
`},preview:function(){var z=c(0),q=c(53),D=c(56),f=c(11),h=i(c(0));function i(S){return S&&S.__esModule?S:{default:S}}var C=[{title:"parent 1",key:"0-0",children:[{title:"parent 1-0",key:"0-0-0",children:[{title:"leaf",key:"0-0-0-0"},{title:"leaf",key:"0-0-0-1"},{title:"leaf",key:"0-0-0-2"}]},{title:"parent 1-1",key:"0-0-1",children:[{title:"leaf",key:"0-0-1-0"}]},{title:"parent 1-2",key:"0-0-2",children:[{title:"leaf",key:"0-0-2-0"},{title:"leaf",key:"0-0-2-1"}]}]}],N=function(){var I=function(R,L){console.log("selected",R,L)};return h.default.createElement(f.Tree,{showLine:!0,switcherIcon:h.default.createElement(D.DownOutlined,null),defaultExpandedKeys:["0-0-0"],onSelect:I,treeData:C})},K=N;return z.createElement(K)}}},4845:function(P,Q,c){P.exports={content:{"zh-CN":[["p","\u4F7F\u7528 ",["code","height"]," \u5C5E\u6027\u5219\u5207\u6362\u4E3A\u865A\u62DF\u6EDA\u52A8\u3002"]],"en-US":[["p","Use virtual list through ",["code","height"]," prop."]]},meta:{order:9,title:{"zh-CN":"\u865A\u62DF\u6EDA\u52A8","en-US":"Virtual scroll"},filename:"components/tree/demo/virtual-scroll.md",id:"components-tree-demo-virtual-scroll"},toc:["ul",["li",["a",{className:"bisheng-toc-h2",href:"#zh-CN",title:"zh-CN"},"zh-CN"]],["li",["a",{className:"bisheng-toc-h2",href:"#en-US",title:"en-US"},"en-US"]]],highlightedCode:["pre",{lang:"tsx",highlighted:`import { Tree } from <span class="token string">'antd'</span><span class="token comment" spellcheck="true">;</span>
import type { DataNode } from <span class="token string">'antd/lib/tree'</span><span class="token comment" spellcheck="true">;</span>
import React from <span class="token string">'react'</span><span class="token comment" spellcheck="true">;</span>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> App<span class="token punctuation">;</span>
`},preview:function(){var z=c(0),q=c(53),D=c(11),f=h(c(0));function h(S){return S&&S.__esModule?S:{default:S}}var i=function S(){for(var I=arguments.length>0&&arguments[0]!==void 0?arguments[0]:"0",T=arguments.length>1&&arguments[1]!==void 0?arguments[1]:3,R=[],L=0;L<10;L+=1){var A="".concat(I,"-").concat(L),J={title:A,key:A};T>0&&(J.children=S(A,T-1)),R.push(J)}return R},C=i(),N=function(){return f.default.createElement(D.Tree,{treeData:C,height:233,defaultExpandAll:!0})},K=N;return z.createElement(K)}}}}]);
