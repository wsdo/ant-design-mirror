...
ReactDOM<span class="token punctuation">.</span><span class="token function">render</span><span class="token punctuation">(</span>
  ...
  mountNode<span class="token punctuation">,</span>
<span class="token punctuation">)</span><span class="token punctuation">;</span>`},preview:function $(){var c=a(0),r=a(28),i=a(7),g=[{value:"zhejiang",label:"Zhejiang",children:[{value:"hangzhou",label:"Hangzhou",children:[{value:"xihu",label:"West Lake"}]}]},{value:"jiangsu",label:"Jiangsu",children:[{value:"nanjing",label:"Nanjing",children:[{value:"zhonghuamen",label:"Zhong Hua Men"}]}]}];function j(l){console.log(l)}return c.createElement(i.Cascader,{options:g,onChange:j,placeholder:"Please select"})}}},3517:function(m,q,a){m.exports={content:{"zh-CN":[["p","这种交互允许只选中父级选项。"]],"en-US":[["p","Allow only select parent options."]]},meta:{order:5,title:{"zh-CN":"选择即改变","en-US":"Change on select"},filename:"components/cascader/demo/change-on-select.md",id:"components-cascader-demo-change-on-select"},toc:["ul",["li",["a",{className:"bisheng-toc-h2",href:"#zh-CN",title:"zh-CN"},"zh-CN"]],["li",["a",{className:"bisheng-toc-h2",href:"#en-US",title:"en-US"},"en-US"]]],highlightedCode:["pre",{lang:"jsx",highlighted:`<span class="token keyword">import</span> <span class="token punctuation">{</span> Cascader <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'antd'</span><span class="token punctuation">;</span>
...
ReactDOM<span class="token punctuation">.</span><span class="token function">render</span><span class="token punctuation">(</span>
  ...
  <span class="token punctuation">/></span></span><span class="token punctuation">,</span>
  mountNode<span class="token punctuation">,</span>
<span class="token punctuation">)</span><span class="token punctuation">;</span>`},preview:function $(){var c=a(0),r=a(28),i=a(7),g=[{value:"zhejiang",label:"Zhejiang",children:[{value:"hangzhou",label:"Hangzhou",children:[{value:"xihu",label:"West Lake"}]}]},{value:"jiangsu",label:"Jiangsu",children:[{value:"nanjing",label:"Nanjing",children:[{value:"zhonghuamen",label:"Zhong Hua Men"}]}]}];function j(l){return c.createElement("div",null,l,c.createElement(i.Divider,{style:{margin:0}}),c.createElement("div",{style:{padding:8}},"The footer is not very short."))}return c.createElement(i.Cascader,{options:g,dropdownRender:j,placeholder:"Please select"})}}},3519:function(m,q,a){m.exports={content:{"zh-CN":[["p","例如给最后一项加上邮编链接。"]],"en-US":[["p","For instance, add an external link after the selected value."]]},meta:{order:7,title:{"zh-CN":"自定义已选项","en-US":"Custom render"},filename:"components/cascader/demo/custom-render.md",id:"components-cascader-demo-custom-render"},toc:["ul",["li",["a",{className:"bisheng-toc-h2",href:"#zh-CN",title:"zh-CN"},"zh-CN"]],["li",["a",{className:"bisheng-toc-h2",href:"#en-US",title:"en-US"},"en-US"]]],highlightedCode:["pre",{lang:"jsx",highlighted:`<span class="token keyword">import</span> <span class="token punctuation">{</span> Cascader <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'antd'</span><span class="token punctuation">;</span>
...
ReactDOM<span class="token punctuation">.</span><span class="token function">render</span><span class="token punctuation">(</span>
  ...
  <span class="token punctuation">/></span></span><span class="token punctuation">,</span>
  mountNode<span class="token punctuation">,</span>
<span class="token punctuation">)</span><span class="token punctuation">;</span>`},preview:function $(){var c=a(0),r=a(28),i=a(7),g=[{value:"zhejiang",label:"Zhejiang",children:[{value:"hangzhou",label:"Hangzhou",children:[{value:"xihu",label:"West Lake",code:752100}]}]},{value:"jiangsu",label:"Jiangsu",children:[{value:"nanjing",label:"Nanjing",children:[{value:"zhonghuamen",label:"Zhong Hua Men",code:453400}]}]}];function j(p,s,t){p.stopPropagation(),console.log("clicked",s,t)}var l=function p(s,t){return s.map(function(w,A){var u=t[A];return A===s.length-1?c.createElement("span",{key:u.value},w," (",c.createElement("a",{onClick:function G(x){return j(x,w,u)}},u.code),")"):c.createElement("span",{key:u.value},w," / ")})};return c.createElement(i.Cascader,{options:g,defaultValue:["zhejiang","hangzhou","xihu"],displayRender:l,style:{width:"100%"}})}}},3520:function(m,q,a){m.exports={content:{"zh-CN":[["p","切换按钮和结果分开。"]],"en-US":[["p","Separate trigger button and result."]]},meta:{order:2,title:{"zh-CN":"可以自定义显示","en-US":"Custom trigger"},filename:"components/cascader/demo/custom-trigger.md",id:"components-cascader-demo-custom-trigger"},toc:["ul",["li",["a",{className:"bisheng-toc-h2",href:"#zh-CN",title:"zh-CN"},"zh-CN"]],["li",["a",{className:"bisheng-toc-h2",href:"#en-US",title:"en-US"},"en-US"]]],highlightedCode:["pre",{lang:"jsx",highlighted:`<span class="token keyword">import</span> <span class="token punctuation">{</span> Cascader <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'antd'</span><span class="token punctuation">;</span>
...
ReactDOM<span class="token punctuation">.</span><span class="token function">render</span><span class="token punctuation">(</span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span><span class="token class-name">Cascader</span></span> <span class="token attr-name">options</span><span class="token script language-javascript"><span class="token script-punctuation punctuation">=</span><span class="token punctuation">{</span>options<span class="token punctuation">}</span></span> <span class="token attr-name">onChange</span><span class="token script language-javascript"><span class="token script-punctuation punctuation">=</span><span class="token punctuation">{</span>onChange<span class="token punctuation">}</span></span> <span class="token punctuation">/></span></span><span class="token punctuation">,</span> mountNode<span class="token punctuation">)</span><span class="token punctuation">;</span>`},preview:function $(){var c=a(0),r=a(28),i=a(7),g=[{value:"zhejiang",label:"Zhejiang",children:[{value:"hangzhou",label:"Hangzhou",children:[{value:"xihu",label:"West Lake"}]}]},{value:"jiangsu",label:"Jiangsu",disabled:!0,children:[{value:"nanjing",label:"Nanjing",children:[{value:"zhonghuamen",label:"Zhong Hua Men"}]}]}];function j(l){console.log(l)}return c.createElement(i.Cascader,{options:g,onChange:j})}}},3523:function(m,q,a){m.exports={content:{"zh-CN":[["p","自定义字段名。"]],"en-US":[["p","Custom field names."]]},meta:{order:10,title:{"zh-CN":"自定义字段名","en-US":"Custom Field Names"},filename:"components/cascader/demo/fields-name.md",id:"components-cascader-demo-fields-name"},toc:["ul",["li",["a",{className:"bisheng-toc-h2",href:"#zh-CN",title:"zh-CN"},"zh-CN"]],["li",["a",{className:"bisheng-toc-h2",href:"#en-US",title:"en-US"},"en-US"]]],highlightedCode:["pre",{lang:"jsx",highlighted:`<span class="token keyword">import</span> <span class="token punctuation">{</span> Cascader <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'antd'</span><span class="token punctuation">;</span>
...
ReactDOM<span class="token punctuation">.</span><span class="token function">render</span><span class="token punctuation">(</span>
  ...
  <span class="token punctuation">/></span></span><span class="token punctuation">,</span>
  mountNode<span class="token punctuation">,</span>
<span class="token punctuation">)</span><span class="token punctuation">;</span>`},preview:function $(){var c=a(0),r=a(28),i=a(7),g=[{code:"zhejiang",name:"Zhejiang",items:[{code:"hangzhou",name:"Hangzhou",items:[{code:"xihu",name:"West Lake"}]}]},{code:"jiangsu",name:"Jiangsu",items:[{code:"nanjing",name:"Nanjing",items:[{code:"zhonghuamen",name:"Zhong Hua Men"}]}]}];function j(l){console.log(l)}return c.createElement(i.Cascader,{fieldNames:{label:"name",value:"code",children:"items"},options:g,onChange:j,placeholder:"Please select"})}}},3524:function(m,q,a){m.exports={content:{"zh-CN":[["p","通过移入展开下级菜单，点击完成选择。"]],"en-US":[["p","Hover to expand sub menu, click to select option."]]},meta:{order:3,title:{"zh-CN":"移入展开","en-US":"Hover"},filename:"components/cascader/demo/hover.md",id:"components-cascader-demo-hover"},toc:["ul",["li",["a",{className:"bisheng-toc-h2",href:"#zh-CN",title:"zh-CN"},"zh-CN"]],["li",["a",{className:"bisheng-toc-h2",href:"#en-US",title:"en-US"},"en-US"]]],highlightedCode:["pre",{lang:"jsx",highlighted:`<span class="token keyword">import</span> <span class="token punctuation">{</span> Cascader <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'antd'</span><span class="token punctuation">;</span>
...
ReactDOM<span class="token punctuation">.</span><span class="token function">render</span><span class="token punctuation">(</span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span><span class="token class-name">LazyOptions</span></span> <span class="token punctuation">/></span></span><span class="token punctuation">,</span> mountNode<span class="token punctuation">)</span><span class="token punctuation">;</span>`},preview:function $(){var c=a(0),r=a(28),i=a(7);function g(b){return typeof Symbol==="function"&&typeof Symbol.iterator==="symbol"?g=function d(e){return typeof e}:g=function d(e){return e&&typeof Symbol==="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},g(b)}function j(b){return t(b)||s(b)||p(b)||l()}function l(){throw new TypeError(`Invalid attempt to spread non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function p(b,d){if(!b)return;if(typeof b==="string")return w(b,d);var e=Object.prototype.toString.call(b).slice(8,-1);e==="Object"&&b.constructor&&(e=b.constructor.name);if(e==="Map"||e==="Set")return Array.from(b);if(e==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(e))return w(b,d)}function s(b){if(typeof Symbol!=="undefined"&&Symbol.iterator in Object(b))return Array.from(b)}function t(b){if(Array.isArray(b))return w(b)}function w(b,d){(d==null||d>b.length)&&(d=b.length);for(var e=0,n=new Array(d);e<d;e++)n[e]=b[e];return n}function A(b,d){if(!(b instanceof d))throw new TypeError("Cannot call a class as a function")}function u(b,d){for(var e=0;e<d.length;e++){var n=d[e];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(b,n.key,n)}}function G(b,d,e){return d&&u(b.prototype,d),e&&u(b,e),b}function x(b,d){if(typeof d!=="function"&&d!==null)throw new TypeError("Super expression must either be null or a function");b.prototype=Object.create(d&&d.prototype,{constructor:{value:b,writable:!0,configurable:!0}}),d&&B(b,d)}function B(b,d){return B=Object.setPrototypeOf||function e(n,y){return n.__proto__=y,n},B(b,d)}function H(b){var d=h();return function e(){var n=k(b),y;if(d){var D=k(this).constructor;y=Reflect.construct(n,arguments,D)}else y=n.apply(this,arguments);return I(this,y)}}function I(b,d){return d&&(g(d)==="object"||typeof d==="function")?d:f(b)}function f(b){if(b===void 0)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return b}function h(){if(typeof Reflect==="undefined"||!Reflect.construct)return!1;if(Reflect.construct.sham)return!1;if(typeof Proxy==="function")return!0;try{return Date.prototype.toString.call(Reflect.construct(Date,[],function(){})),!0}catch(b){return!1}}function k(b){return k=Object.setPrototypeOf?Object.getPrototypeOf:function d(e){return e.__proto__||Object.getPrototypeOf(e)},k(b)}function o(b,d,e){return d in b?Object.defineProperty(b,d,{value:e,enumerable:!0,configurable:!0,writable:!0}):b[d]=e,b}var v=[{value:"zhejiang",label:"Zhejiang",isLeaf:!1},{value:"jiangsu",label:"Jiangsu",isLeaf:!1}],C=function(b){x(e,b);var d=H(e);function e(){var n;A(this,e);for(var y=arguments.length,D=new Array(y),E=0;E<y;E++)D[E]=arguments[E];return n=d.call.apply(d,[this].concat(D)),o(f(n),"state",{options:v}),o(f(n),"onChange",function(F,z){console.log(F,z)}),o(f(n),"loadData",function(F){var z=F[F.length-1];z.loading=!0,setTimeout(function(){z.loading=!1,z.children=[{label:"".concat(z.label," Dynamic 1"),value:"dynamic1"},{label:"".concat(z.label," Dynamic 2"),value:"dynamic2"}],n.setState({options:j(n.state.options)})},1e3)}),n}return G(e,[{key:"render",value:function n(){return c.createElement(i.Cascader,{options:this.state.options,loadData:this.loadData,onChange:this.onChange,changeOnSelect:!0})}}]),e}(c.Component);return c.createElement(C,null)}}},3526:function(m,q,a){m.exports={content:{"zh-CN":[["p","可以直接搜索选项并选择。"],["blockquote",["p",["code","Cascader[showSearch]"]," 暂不支持服务端搜索，更多信息见 ",["a",{title:null,href:"https://github.com/ant-design/ant-design/issues/5547"},"#5547"]]]],"en-US":[["p","Search and select options directly."],["blockquote",["p","Now, ",["code","Cascader[showSearch]"]," doesn't support search on server, more info ",["a",{title:null,href:"https://github.com/ant-design/ant-design/issues/5547"},"#5547"]]]]},meta:{order:8,title:{"zh-CN":"搜索","en-US":"Search"},filename:"components/cascader/demo/search.md",id:"components-cascader-demo-search"},toc:["ul",["li",["a",{className:"bisheng-toc-h2",href:"#zh-CN",title:"zh-CN"},"zh-CN"]],["li",["a",{className:"bisheng-toc-h2",href:"#en-US",title:"en-US"},"en-US"]]],highlightedCode:["pre",{lang:"jsx",highlighted:`<span class="token keyword">import</span> <span class="token punctuation">{</span> Cascader <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'antd'</span><span class="token punctuation">;</span>
...
ReactDOM<span class="token punctuation">.</span><span class="token function">render</span><span class="token punctuation">(</span>
  ...
  mountNode<span class="token punctuation">,</span>
<span class="token punctuation">)</span><span class="token punctuation">;</span>`},preview:function $(){var c=a(0),r=a(28),i=a(7),g=a(44),j=[{value:"zhejiang",label:"Zhejiang",children:[{value:"hangzhou",label:"Hangzhou",children:[{value:"xihu",label:"West Lake"}]}]},{value:"jiangsu",label:"Jiangsu",children:[{value:"nanjing",label:"Nanjing",children:[{value:"zhonghuamen",label:"Zhong Hua Men"}]}]}];function l(p){console.log(p)}return c.createElement(c.Fragment,null,c.createElement(i.Cascader,{suffixIcon:c.createElement(g.SmileOutlined,null),options:j,onChange:l,placeholder:"Please select"}),c.createElement("br",null),c.createElement("br",null),c.createElement(i.Cascader,{suffixIcon:"ab",options:j,onChange:l,placeholder:"Please select"}),c.createElement("br",null),c.createElement("br",null),c.createElement(i.Cascader,{expandIcon:c.createElement(g.SmileOutlined,null),options:j,onChange:l,placeholder:"Please select"}),c.createElement("br",null),c.createElement("br",null),c.createElement(i.Cascader,{expandIcon:"ab",options:j,onChange:l,placeholder:"Please select"}))}}}}]);
