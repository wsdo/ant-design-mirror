...
ReactDOM<span class="token punctuation">.</span><span class="token function">render</span><span class="token punctuation">(</span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span><span class="token class-name">CitySwitcher</span></span> <span class="token punctuation">/></span></span><span class="token punctuation">,</span> mountNode<span class="token punctuation">)</span><span class="token punctuation">;</span>`},preview:function(){var a=n(0),v=n(38);function o(s){return o=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(t){return typeof t}:function(t){return t&&typeof Symbol=="function"&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t},o(s)}var u=n(11);function c(s,t){if(!(s instanceof t))throw new TypeError("Cannot call a class as a function")}function e(s,t){for(var i=0;i<t.length;i++){var k=t[i];k.enumerable=k.enumerable||!1,k.configurable=!0,"value"in k&&(k.writable=!0),Object.defineProperty(s,k.key,k)}}function r(s,t,i){return t&&e(s.prototype,t),i&&e(s,i),Object.defineProperty(s,"prototype",{writable:!1}),s}function d(s,t){if(typeof t!="function"&&t!==null)throw new TypeError("Super expression must either be null or a function");Object.defineProperty(s,"prototype",{value:Object.create(t&&t.prototype,{constructor:{value:s,writable:!0,configurable:!0}}),writable:!1}),t&&b(s,t)}function b(s,t){return b=Object.setPrototypeOf||function(k,f){return k.__proto__=f,k},b(s,t)}function z(s){var t=S();return function(){var k=N(s),f;if(t){var y=N(this).constructor;f=Reflect.construct(k,arguments,y)}else f=k.apply(this,arguments);return w(this,f)}}function w(s,t){if(t&&(o(t)==="object"||typeof t=="function"))return t;if(t!==void 0)throw new TypeError("Derived constructors may only return object or undefined");return j(s)}function j(s){if(s===void 0)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return s}function S(){if(typeof Reflect=="undefined"||!Reflect.construct||Reflect.construct.sham)return!1;if(typeof Proxy=="function")return!0;try{return Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],function(){})),!0}catch(s){return!1}}function N(s){return N=Object.setPrototypeOf?Object.getPrototypeOf:function(i){return i.__proto__||Object.getPrototypeOf(i)},N(s)}function O(s,t,i){return t in s?Object.defineProperty(s,t,{value:i,enumerable:!0,configurable:!0,writable:!0}):s[t]=i,s}var p=[{value:"zhejiang",label:"Zhejiang",children:[{value:"hangzhou",label:"Hangzhou"}]},{value:"jiangsu",label:"Jiangsu",children:[{value:"nanjing",label:"Nanjing"}]}],g=function(s){d(i,s);var t=z(i);function i(){var k;c(this,i);for(var f=arguments.length,y=new Array(f),C=0;C<f;C++)y[C]=arguments[C];return k=t.call.apply(t,[this].concat(y)),O(j(k),"state",{text:"Unselect"}),O(j(k),"onChange",function(x,R){k.setState({text:R.map(function(U){return U.label}).join(", ")})}),k}return r(i,[{key:"render",value:function(){return a.createElement("span",null,this.state.text,"\xA0",a.createElement(u.Cascader,{options:p,onChange:this.onChange},a.createElement("a",{href:"#"},"Change city")))}}]),i}(a.Component);return a.createElement(g,null)}}},3365:function(l,h,n){l.exports={content:{"zh-CN":[["p","\u9ED8\u8BA4\u503C\u901A\u8FC7\u6570\u7EC4\u7684\u65B9\u5F0F\u6307\u5B9A\u3002"]],"en-US":[["p","Specifies default value by an array."]]},meta:{order:1,title:{"zh-CN":"\u9ED8\u8BA4\u503C","en-US":"Default value"},filename:"components/cascader/demo/default-value.md",id:"components-cascader-demo-default-value"},toc:["ul",["li",["a",{className:"bisheng-toc-h2",href:"#zh-CN",title:"zh-CN"},"zh-CN"]],["li",["a",{className:"bisheng-toc-h2",href:"#en-US",title:"en-US"},"en-US"]]],highlightedCode:["pre",{lang:"jsx",highlighted:`<span class="token keyword">import</span> <span class="token punctuation">{</span> Cascader <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'antd'</span><span class="token punctuation">;</span>
...
ReactDOM<span class="token punctuation">.</span><span class="token function">render</span><span class="token punctuation">(</span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span><span class="token class-name">LazyOptions</span></span> <span class="token punctuation">/></span></span><span class="token punctuation">,</span> mountNode<span class="token punctuation">)</span><span class="token punctuation">;</span>`},preview:function(){var a=n(0),v=n(38),o=n(11);function u(p){return r(p)||e(p)||z(p)||c()}function c(){throw new TypeError(`Invalid attempt to spread non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function e(p){if(typeof Symbol!="undefined"&&p[Symbol.iterator]!=null||p["@@iterator"]!=null)return Array.from(p)}function r(p){if(Array.isArray(p))return w(p)}function d(p,g){return S(p)||j(p,g)||z(p,g)||b()}function b(){throw new TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function z(p,g){if(!!p){if(typeof p=="string")return w(p,g);var s=Object.prototype.toString.call(p).slice(8,-1);if(s==="Object"&&p.constructor&&(s=p.constructor.name),s==="Map"||s==="Set")return Array.from(p);if(s==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(s))return w(p,g)}}function w(p,g){(g==null||g>p.length)&&(g=p.length);for(var s=0,t=new Array(g);s<g;s++)t[s]=p[s];return t}function j(p,g){var s=p==null?null:typeof Symbol!="undefined"&&p[Symbol.iterator]||p["@@iterator"];if(s!=null){var t=[],i=!0,k=!1,f,y;try{for(s=s.call(p);!(i=(f=s.next()).done)&&(t.push(f.value),!(g&&t.length===g));i=!0);}catch(C){k=!0,y=C}finally{try{!i&&s.return!=null&&s.return()}finally{if(k)throw y}}return t}}function S(p){if(Array.isArray(p))return p}var N=[{value:"zhejiang",label:"Zhejiang",isLeaf:!1},{value:"jiangsu",label:"Jiangsu",isLeaf:!1}],O=function(){var g=a.useState(N),s=d(g,2),t=s[0],i=s[1],k=function(C,x){console.log(C,x)},f=function(C){var x=C[C.length-1];x.loading=!0,setTimeout(function(){x.loading=!1,x.children=[{label:"".concat(x.label," Dynamic 1"),value:"dynamic1"},{label:"".concat(x.label," Dynamic 2"),value:"dynamic2"}],i(u(t))},1e3)};return a.createElement(o.Cascader,{options:t,loadData:f,onChange:k,changeOnSelect:!0})};return a.createElement(O,null)}}},3370:function(l,h,n){l.exports={content:{"zh-CN":[["p","\u4E00\u6B21\u6027\u9009\u62E9\u591A\u4E2A\u9009\u9879\u3002"]],"en-US":[["p","Select multiple options"]]},meta:{order:5.1,version:"4.17.0",title:{"zh-CN":"\u591A\u9009","en-US":"Multiple"},filename:"components/cascader/demo/multiple.md",id:"components-cascader-demo-multiple"},toc:["ul",["li",["a",{className:"bisheng-toc-h2",href:"#zh-CN",title:"zh-CN"},"zh-CN"]],["li",["a",{className:"bisheng-toc-h2",href:"#en-US",title:"en-US"},"en-US"]]],highlightedCode:["pre",{lang:"jsx",highlighted:`<span class="token keyword">import</span> <span class="token punctuation">{</span> Cascader <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'antd'</span><span class="token punctuation">;</span>
