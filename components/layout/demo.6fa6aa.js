...
`}},3577:function(b,S,e){b.exports={content:{"zh-CN":[["p","\u4FEE\u6539\u5185\u5BB9\u524D\uFF0C\u8BF7\u5C1D\u8BD5\u6B64 Demo \u67E5\u770B\u6837\u5F0F\u662F\u5426\u6296\u52A8\u3002"],["pre",{lang:"tsx",highlighted:`import { Layout<span class="token punctuation">,</span> Menu<span class="token punctuation">,</span> MenuProps } from <span class="token string">'antd'</span><span class="token comment" spellcheck="true">;</span>
import {
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token operator">=></span> <span class="token punctuation">(</span>
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span><span class="token class-name">Layout</span></span><span class="token punctuation">></span></span>
    ...
    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span><span class="token class-name">Layout</span></span><span class="token punctuation">></span></span>
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span><span class="token class-name">Layout</span></span><span class="token punctuation">></span></span>
<span class="token punctuation">)</span><span class="token punctuation">;</span>`},preview:function(){var n=e(0),E=e(43),s=e(11),c=e(53),u=s.Layout.Header,y=s.Layout.Content,r=s.Layout.Footer,h=s.Layout.Sider,x=function(){return n.createElement(s.Layout,null,n.createElement(h,{breakpoint:"lg",collapsedWidth:"0",onBreakpoint:function(g){console.log(g)},onCollapse:function(g,f){console.log(g,f)}},n.createElement("div",{className:"logo"}),n.createElement(s.Menu,{theme:"dark",mode:"inline",defaultSelectedKeys:["4"],items:[c.UserOutlined,c.VideoCameraOutlined,c.UploadOutlined,c.UserOutlined].map(function(d,g){return{key:String(g+1),icon:n.createElement(d),label:"nav ".concat(g+1)}})})),n.createElement(s.Layout,null,n.createElement(u,{className:"site-layout-sub-header-background",style:{padding:0}}),n.createElement(y,{style:{margin:"24px 16px 0"}},n.createElement("div",{className:"site-layout-background",style:{padding:24,minHeight:360}},"content")),n.createElement(r,{style:{textAlign:"center"}},"Ant Design \xA92018 Created by Ant UED")))};return n.createElement(x)},style:`#components-layout-demo-responsive .logo {
  height: 32px;
  margin: 16px;
  background: rgba(255, 255, 255, 0.2);
}
