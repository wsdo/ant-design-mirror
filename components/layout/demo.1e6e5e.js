...
`}},4407:function(v,E,p){v.exports={content:{"zh-CN":[["p","\u4FEE\u6539\u5185\u5BB9\u524D\uFF0C\u8BF7\u5C1D\u8BD5\u6B64 Demo \u67E5\u770B\u6837\u5F0F\u662F\u5426\u6296\u52A8\u3002"],["pre",{lang:"tsx",highlighted:`import {
...
<span class="token keyword">export</span> <span class="token keyword">default</span> App<span class="token punctuation">;</span>
`},preview:function(){var C=p(0),H=p(56),o=p(60),s=p(12),n=e(p(0));function e(h){return h&&h.__esModule?h:{default:h}}var d=s.Layout.Header,f=s.Layout.Content,b=s.Layout.Footer,x=s.Layout.Sider,m=function(){return n.default.createElement(s.Layout,null,n.default.createElement(x,{breakpoint:"lg",collapsedWidth:"0",onBreakpoint:function(g){console.log(g)},onCollapse:function(g,L){console.log(g,L)}},n.default.createElement("div",{className:"logo"}),n.default.createElement(s.Menu,{theme:"dark",mode:"inline",defaultSelectedKeys:["4"],items:[o.UserOutlined,o.VideoCameraOutlined,o.UploadOutlined,o.UserOutlined].map(function(i,g){return{key:String(g+1),icon:n.default.createElement(i),label:"nav ".concat(g+1)}})})),n.default.createElement(s.Layout,null,n.default.createElement(d,{className:"site-layout-sub-header-background",style:{padding:0}}),n.default.createElement(f,{style:{margin:"24px 16px 0"}},n.default.createElement("div",{className:"site-layout-background",style:{padding:24,minHeight:360}},"content")),n.default.createElement(b,{style:{textAlign:"center"}},"Ant Design \xA92018 Created by Ant UED")))},y=m;return C.createElement(y)},style:`#components-layout-demo-responsive .logo {
  height: 32px;
  margin: 16px;
  background: rgba(255, 255, 255, 0.2);
}
...
<span class="token keyword">export</span> <span class="token keyword">default</span> App<span class="token punctuation">;</span>
`},preview:function(){var C=p(0),H=p(56);function o(a){return o=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(l){return typeof l}:function(l){return l&&typeof Symbol=="function"&&l.constructor===Symbol&&l!==Symbol.prototype?"symbol":typeof l},o(a)}var s=p(60),n=p(12),e=f(p(0));function d(a){if(typeof WeakMap!="function")return null;var l=new WeakMap,k=new WeakMap;return(d=function(w){return w?k:l})(a)}function f(a,l){if(!l&&a&&a.__esModule)return a;if(a===null||o(a)!=="object"&&typeof a!="function")return{default:a};var k=d(l);if(k&&k.has(a))return k.get(a);var r={},w=Object.defineProperty&&Object.getOwnPropertyDescriptor;for(var S in a)if(S!=="default"&&Object.prototype.hasOwnProperty.call(a,S)){var A=w?Object.getOwnPropertyDescriptor(a,S):null;A&&(A.get||A.set)?Object.defineProperty(r,S,A):r[S]=a[S]}return r.default=a,k&&k.set(a,r),r}function b(a,l){return i(a)||h(a,l)||m(a,l)||x()}function x(){throw new TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function m(a,l){if(!!a){if(typeof a=="string")return y(a,l);var k=Object.prototype.toString.call(a).slice(8,-1);if(k==="Object"&&a.constructor&&(k=a.constructor.name),k==="Map"||k==="Set")return Array.from(a);if(k==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(k))return y(a,l)}}function y(a,l){(l==null||l>a.length)&&(l=a.length);for(var k=0,r=new Array(l);k<l;k++)r[k]=a[k];return r}function h(a,l){var k=a==null?null:typeof Symbol!="undefined"&&a[Symbol.iterator]||a["@@iterator"];if(k!=null){var r=[],w=!0,S=!1,A,M;try{for(k=k.call(a);!(w=(A=k.next()).done)&&(r.push(A.value),!(l&&r.length===l));w=!0);}catch(F){S=!0,M=F}finally{try{!w&&k.return!=null&&k.return()}finally{if(S)throw M}}return r}}function i(a){if(Array.isArray(a))return a}var g=n.Layout.Header,L=n.Layout.Content,B=n.Layout.Footer,U=n.Layout.Sider;function O(a,l,k,r){return{key:l,icon:k,children:r,label:a}}var u=[O("Option 1","1",e.default.createElement(s.PieChartOutlined,null)),O("Option 2","2",e.default.createElement(s.DesktopOutlined,null)),O("User","sub1",e.default.createElement(s.UserOutlined,null),[O("Tom","3"),O("Bill","4"),O("Alex","5")]),O("Team","sub2",e.default.createElement(s.TeamOutlined,null),[O("Team 1","6"),O("Team 2","8")]),O("Files","9",e.default.createElement(s.FileOutlined,null))],t=function(){var l=(0,e.useState)(!1),k=b(l,2),r=k[0],w=k[1];return e.default.createElement(n.Layout,{style:{minHeight:"100vh"}},e.default.createElement(U,{collapsible:!0,collapsed:r,onCollapse:function(A){return w(A)}},e.default.createElement("div",{className:"logo"}),e.default.createElement(n.Menu,{theme:"dark",defaultSelectedKeys:["1"],mode:"inline",items:u})),e.default.createElement(n.Layout,{className:"site-layout"},e.default.createElement(g,{className:"site-layout-background",style:{padding:0}}),e.default.createElement(L,{style:{margin:"0 16px"}},e.default.createElement(n.Breadcrumb,{style:{margin:"16px 0"}},e.default.createElement(n.Breadcrumb.Item,null,"User"),e.default.createElement(n.Breadcrumb.Item,null,"Bill")),e.default.createElement("div",{className:"site-layout-background",style:{padding:24,minHeight:360}},"Bill is a cat.")),e.default.createElement(B,{style:{textAlign:"center"}},"Ant Design \xA92018 Created by Ant UED")))},c=t;return C.createElement(c)},style:`#components-layout-demo-side .logo {
  height: 32px;
  margin: 16px;
  background: rgba(255, 255, 255, 0.3);
}
