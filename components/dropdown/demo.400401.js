...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function k(o,c){if(!!o){if(typeof o=="string")return i(o,c);var m=Object.prototype.toString.call(o).slice(8,-1);if(m==="Object"&&o.constructor&&(m=o.constructor.name),m==="Map"||m==="Set")return Array.from(o);if(m==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(m))return i(o,c)}}function i(o,c){(c==null||c>o.length)&&(c=o.length);for(var m=0,v=new Array(c);m<c;m++)v[m]=o[m];return v}function b(o,c){var m=o==null?null:typeof Symbol!="undefined"&&o[Symbol.iterator]||o["@@iterator"];if(m!=null){var v=[],p=!0,r=!1,g,h;try{for(m=m.call(o);!(p=(g=m.next()).done)&&(v.push(g.value),!(c&&v.length===c));p=!0);}catch(D){r=!0,h=D}finally{try{!p&&m.return!=null&&m.return()}finally{if(r)throw h}}return v}}function f(o){if(Array.isArray(o))return o}var O=function(c){n.message.info("Click on left button."),console.log("click left button",c)},x=function(c){n.message.info("Click on menu item."),console.log("click",c)},M=a.default.createElement(n.Menu,{onClick:x,items:[{label:"1st menu item",key:"1",icon:a.default.createElement(t.UserOutlined,null)},{label:"2nd menu item",key:"2",icon:a.default.createElement(t.UserOutlined,null)},{label:"3rd menu item",key:"3",icon:a.default.createElement(t.UserOutlined,null)}]}),E=function(){return a.default.createElement(n.Space,{wrap:!0},a.default.createElement(n.Dropdown.Button,{onClick:O,overlay:M},"Dropdown"),a.default.createElement(n.Dropdown.Button,{overlay:M,placement:"bottom",icon:a.default.createElement(t.UserOutlined,null)},"Dropdown"),a.default.createElement(n.Dropdown.Button,{onClick:O,overlay:M,disabled:!0},"Dropdown"),a.default.createElement(n.Dropdown.Button,{overlay:M,buttonsRender:function(m){var v=l(m,2),p=v[0],r=v[1];return[a.default.createElement(n.Tooltip,{title:"tooltip",key:"leftButton"},p),a.default.cloneElement(r,{loading:!0})]}},"With Tooltip"),a.default.createElement(n.Dropdown,{overlay:M},a.default.createElement(n.Button,null,a.default.createElement(n.Space,null,"Button",a.default.createElement(t.DownOutlined,null)))))},u=E;return y.createElement(u)}}},4296:function(d,C,s){d.exports={content:{"zh-CN":[["p","\u70B9\u51FB\u83DC\u5355\u9879\u540E\u4F1A\u89E6\u53D1\u4E8B\u4EF6\uFF0C\u7528\u6237\u53EF\u4EE5\u901A\u8FC7\u76F8\u5E94\u7684\u83DC\u5355\u9879 key \u8FDB\u884C\u4E0D\u540C\u7684\u64CD\u4F5C\u3002"]],"en-US":[["p","An event will be triggered when you click menu items, in which you can make different operations according to item's key."]]},meta:{order:4,title:{"zh-CN":"\u89E6\u53D1\u4E8B\u4EF6","en-US":"Click event"},filename:"components/dropdown/demo/event.md",id:"components-dropdown-demo-event"},toc:["ul",["li",["a",{className:"bisheng-toc-h2",href:"#zh-CN",title:"zh-CN"},"zh-CN"]],["li",["a",{className:"bisheng-toc-h2",href:"#en-US",title:"en-US"},"en-US"]]],highlightedCode:["pre",{lang:"tsx",highlighted:`import { DownOutlined } from <span class="token string">'@ant-design/icons'</span><span class="token comment" spellcheck="true">;</span>
import type { MenuProps } from <span class="token string">'antd'</span><span class="token comment" spellcheck="true">;</span>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> App<span class="token punctuation">;</span>`,jsx:`<span class="token keyword">import</span> <span class="token punctuation">{</span> DownOutlined<span class="token punctuation">,</span> MailOutlined<span class="token punctuation">,</span> SettingOutlined <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'@ant-design/icons'</span><span class="token punctuation">;</span>
<span class="token keyword">import</span> <span class="token punctuation">{</span> Dropdown<span class="token punctuation">,</span> Menu<span class="token punctuation">,</span> Space <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'antd'</span><span class="token punctuation">;</span>
