...
</Form.Item>`]],["p","你可以参考",["a",{title:null,href:"#components-form-demo-control-hooks"},"示例"],"查看具体使用场景。"],["h3","messageVariables"],["p","你可以通过 ",["code","messageVariables"]," 修改 Form.Item 的默认验证信息。"],["pre",{lang:"jsx",highlighted:`<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>Form</span><span class="token punctuation">></span></span>
...
</Form>`]],["h2","Form.List"],["p","为字段提供数组化管理。"],["table",["thead",["tr",["th","参数"],["th","说明"],["th","类型"],["th","默认值"],["th","版本"]]],["tbody",["tr",["td","children"],["td","渲染函数"],["td","(fields: Field","[","], operation: { add, remove, move }) => React.ReactNode"],["td","-"],["td"]],["tr",["td","name"],["td","字段名，支持数组"],["td",["a",{title:null,href:"#NamePath"},"NamePath"]],["td","-"],["td"]],["tr",["td","rules"],["td","校验规则，仅支持自定义规则。需要配合 ",["a",{title:null,href:"#Form.ErrorList"},"ErrorList"]," 一同使用。"],["td","{ validator, message }","[","]"],["td","-"],["td","4.7.0"]]]],["pre",{lang:"tsx",highlighted:`<span class="token operator">&lt;</span>Form<span class="token punctuation">.</span>List<span class="token operator">></span>
...
</Form.Provider>`]],["h3","FormInstance"],["table",["thead",["tr",["th","名称"],["th","说明"],["th","类型"],["th","版本"]]],["tbody",["tr",["td","getFieldError"],["td","获取对应字段名的错误信息"],["td","(name: ",["a",{title:null,href:"#NamePath"},"NamePath"],") => string","[","]"],["td"]],["tr",["td","getFieldInstance"],["td","获取对应字段实例"],["td","(name: ",["a",{title:null,href:"#NamePath"},"NamePath"],") => any"],["td","4.4.0"]],["tr",["td","getFieldsError"],["td","获取一组字段名对应的错误信息，返回为数组形式"],["td","(nameList?: ",["a",{title:null,href:"#NamePath"},"NamePath"],"[","]) => FieldError","[","]"],["td"]],["tr",["td","getFieldsValue"],["td","获取一组字段名对应的值，会按照对应结构返回"],["td","(nameList?: ",["a",{title:null,href:"#NamePath"},"NamePath"],"[","], filterFunc?: (meta: { touched: boolean, validating: boolean }) => boolean) => any"],["td"]],["tr",["td","getFieldValue"],["td","获取对应字段名的值"],["td","(name: ",["a",{title:null,href:"#NamePath"},"NamePath"],") => any"],["td"]],["tr",["td","isFieldsTouched"],["td","检查一组字段是否被用户操作过，",["code","allTouched"]," 为 ",["code","true"]," 时检查是否所有字段都被操作过"],["td","(nameList?: ",["a",{title:null,href:"#NamePath"},"NamePath"],"[","], allTouched?: boolean) => boolean"],["td"]],["tr",["td","isFieldTouched"],["td","检查对应字段是否被用户操作过"],["td","(name: ",["a",{title:null,href:"#NamePath"},"NamePath"],") => boolean"],["td"]],["tr",["td","isFieldValidating"],["td","检查一组字段是否正在校验"],["td","(name: ",["a",{title:null,href:"#NamePath"},"NamePath"],") => boolean"],["td"]],["tr",["td","resetFields"],["td","重置一组字段到 ",["code","initialValues"]],["td","(fields?: ",["a",{title:null,href:"#NamePath"},"NamePath"],"[","]) => void"],["td"]],["tr",["td","scrollToField"],["td","滚动到对应字段位置"],["td","(name: ",["a",{title:null,href:"#NamePath"},"NamePath"],", options: ","[",["a",{title:null,href:"https://github.com/stipsan/scroll-into-view-if-needed/tree/ece40bd9143f48caf4b99503425ecb16b0ad8249#options"},"ScrollOptions"],"]) => void"],["td"]],["tr",["td","setFields"],["td","设置一组字段状态"],["td","(fields: ",["a",{title:null,href:"#FieldData"},"FieldData"],"[","]) => void"],["td"]],["tr",["td","setFieldsValue"],["td","设置表单的值"],["td","(values) => void"],["td"]],["tr",["td","submit"],["td","提交表单，与点击 ",["code","submit"]," 按钮效果相同"],["td","() => void"],["td"]],["tr",["td","validateFields"],["td","触发表单验证"],["td","(nameList?: ",["a",{title:null,href:"#NamePath"},"NamePath"],"[","]) => Promise"],["td"]]]],["h4","validateFields 返回示例"],["pre",{lang:"jsx",highlighted:`<span class="token function">validateFields</span><span class="token punctuation">(</span><span class="token punctuation">)</span>
...
<span class="token operator">&lt;</span><span class="token operator">/</span>Form<span class="token punctuation">.</span>List<span class="token operator">></span>`},["code",`<Form.List name="users">
  {fields =>
    fields.map(field => (
...
</Form.List>`]],["p","依赖则是：",["code","['users', 0, 'name']"]],["style",`
  .site-form-item-icon {
